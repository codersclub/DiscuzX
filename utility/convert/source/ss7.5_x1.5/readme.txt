====================================
SupeSite 7.5 升级至 Discuz! X1.5 说明
====================================

特别警示!!!
Discuz! X1.5中并未具备SupeSite 7.5中的全部功能，
此转换程序，仅转换SupeSite 7.5中的资讯分类、资讯文章数据到 Discuz! X1.5产品的文章系统中。
其他数据将不进行转换。
因此，数据转换后，Discuz! X1.5产品存在原有SupeSite功能丢失和数据丢失问题，请自行权衡决定是否转换升级。
...
3. 上传 Discuz! X1.5 产品的upload目录中的程序到SupeSite目录
4. 执行安装程序 /install
   安装的时候请指定原SupeSite挂接的UCenter Server地址

II 升级SupeSite数据
---------------
1. 安装完毕，测试Discuz! X1.5可以正常运行以后，上传convert 程序到Discuz! X1.5根目录
2. 执行 /convert
3. 选择相应的程序版本，开始转换
