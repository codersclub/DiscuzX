...
$lang = array (
	...
	array (
		'index' => 
		array (
			'手机版设置' => 'action=setting&operation=mobile',
		),
		'text' => 
		array (
			0 => '手机版设置',
	...
	array (
		'index' => 
		array (
			'发送手机短信' => 'action=members&operation=newsletter&do=sms',
		),
		'text' => 
		array (
			0 => '发送手机短信',
	...
	array (
		'index' => 
		array (
			'资料审核' => 'action=verify&operation=verify',
		),
		'text' => 
		array (
			0 => '资料审核',
	...
	array (
		'index' => 
		array (
			'账号保镖' => 'action=setting&operation=accountguard',
		),
		'text' => 
		array (
			0 => '账号保镖',
	...
	array (
		'index' => 
		array (
			'密钥更新' => 'action=checktools&operation=replacekey',
		),
		'text' => 
		array (
			0 => '密钥更新',
	...
	array (
		...
		array (
			...
			69 => '允许置顶 I',
			70 => 'admingroup_edit_stick_thread_2',
			71 => '允许置顶 I/II',
			72 => 'admingroup_edit_stick_thread_3',
			73 => '允许置顶 I/II/III',
			74 => 'admingroup_edit_digest_thread_none',
			75 => '不允许精华',
			76 => 'admingroup_edit_digest_thread_1',
			77 => '允许精华 I',
			78 => 'admingroup_edit_digest_thread_2',
			79 => '允许精华 I/II',
			80 => 'admingroup_edit_digest_thread_3',
			81 => '允许精华 I/II/III',
		),
	),
	127 => 
	...
	array (
		...
		array (
			...
			22 => '允许管理推荐好友',
			23 => 'admingroup_edit_manage_magic',
			24 => '允许管理道具',
			25 => 'admingroup_edit_manage_click',
			26 => '允许管理表态动作',
		),
	),
	130 => 
	...
	array (
		'index' => 
		array (
			'导出充值卡密最多支持 10000 条数据，导出的文件可用 EXCEL、WPS表格、腾讯文档等工具打开。' => 'action=card&operation=manage',
		),
		'text' => 
		array (
			0 => '导出充值卡密最多支持 10000 条数据，导出的文件可用 EXCEL、WPS表格、腾讯文档等工具打开。',
			1 => 'card_manage_tips',
			2 => '导出充值卡密最多支持 10000 条数据，导出的文件可用 EXCEL、WPS表格、腾讯文档等工具打开。',
		),
	),
	145 => 
	array (
	...
	array (
		...
		array (
			0 => '表态动作',
			1 => 'click_edit_tips',
			2 => '本功能用于设置日志/图片/文章表态动作，动作图片中请填写图片文件名，并将相应图片文件上传到 static/image/click/ 目录中或直接填写图片 URL 地址。警告：站点运营一段时间后，中途改变各表情的顺序将会影响之前的表态结果每个类型最多启用8个动作',
		),
	),
	148 => 
	array (
		...
		array (
			...
			24 => 'collection_uid',
			25 => '淘专辑作者 UID',
			26 => 'collection_recommend_index_autonumber',
			27 => '首页推荐数量',
			28 => '设置后，会在首页推荐指定数量的热门专辑，设为“0”则关闭推荐功能。当手动推荐数量未达到设置的数量时，系统会自动推荐专辑。',
		),
	),
	149 => 
	array (
	...
	array (
		...
		array (
			...
			21 => '根据需要自行选择需要备份的数据表',
			22 => 'db_export_shell',
			23 => '系统 MySQL Dump (Shell) 备份',
			24 => 'db_export_multivol',
			25 => 'Discuz! 分卷备份 - 文件长度限制(单位：KB)',
			26 => 'default',
			27 => '默认',
			28 => 'db_export_zip_1',
			29 => '多分卷压缩成一个文件',
	...
	array (
		...
		array (
			'数据库' => 'action=db&operation=export',
			'恢复' => 'action=db&operation=import',
		),
		'text' => 
		array (
			0 => '数据库 &raquo; 恢复',
			1 => 'db_import_tips',
			2 => '本功能在恢复备份数据的同时，将全部覆盖原有数据，请确定恢复前已将站点关闭，恢复全部完成后可以将站点重新开放。出于安全考虑，我们强烈建议您恢复数据库备份文件后删除文件或设置文件不可通过 URL 访问。恢复数据前请在 Discuz! 安装文件目录下 utility 文件夹内找到 restore.php 文件，然后将 restore.php 文件上传到程序文件夹data目录下。为了您站点的安全，成功恢复数据后请务必及时删除 restore.php 文件。您可以在数据备份记录处查看站点的备份文件的详细信息，删除过期的备份,并导入需要的备份。',
			3 => 'db_import',
			4 => '数据恢复',
		),
	),
	...
	array (
		...
		array (
			...
			2 => '各自绑定的域名不能相同，域名不需要添加“http://”，也不要以“/”结尾，例如：portal.discuz.vip任意开启一项域名，需要配置默认域名，否则会造成多入口问题当开启多域名时，请在 config/config_global.php 中修改 cookiedomain 值来设置 cookie 作用域',
		),
	),
	160 => 
	array (
	...
	array (
		...
		array (
			...
			5 => 'ec_alipay_on',
			6 => '是否启用支付宝',
			7 => 'ec_alipay_sign_mode',
			8 => '加签模式',
			9 => '支付宝开放平台：查看； 企业开发者若涉及 资金类支出接口 接入，必须使用 公钥证书模式加签 方式； 个人开发者不涉及到资金类接口，建议使用 普通公钥模式加签 进行加签； 接口加签：配置接口加签方式',
			10 => 'ec_alipay_appid',
			11 => '(必须)应用ID',
			12 => '支付宝分配给开发者的应用ID，查看我的应用列表',
			13 => 'ec_alipay_app_private_key',
			14 => '(必须)RSA2(SHA256)开发者私钥',
			15 => '普通公钥模式获取详情请参见 获取普通公钥',
			16 => 'ec_alipay_public_key',
			17 => '(必须)RSA2(SHA256)支付宝公钥',
			18 => '普通公钥模式获取详情请参见 获取普通公钥',
			19 => 'ec_alipay_app_cert',
			20 => '(必须)RSA2(SHA256)应用公钥证书',
			21 => '公钥证书模式获取详情请参见 获取公钥证书；appCertPublicKey_*.crt，使用记事本打开此文件，全选复制内容到此处',
			22 => 'ec_alipay_alipay_cert',
			23 => '(必须)RSA2(SHA256)支付宝公钥证书',
			24 => '公钥证书模式获取详情请参见 获取公钥证书；alipayCertPublicKey_RSA2.crt，使用记事本打开此文件，全选复制内容到此处',
			25 => 'ec_alipay_alipay_root_cert',
			26 => '(必须)RSA2(SHA256)支付宝根证书',
			27 => '公钥证书模式获取详情请参见 获取公钥证书；alipayRootCert.crt，使用记事本打开此文件，全选复制内容到此处',
			28 => 'ec_alipay_check',
			29 => '支付测试',
			30 => '本测试将模拟提交 0.01 元人民币的订单进行测试，如果提交后成功出现付款界面，说明您站点的支付宝功能可以正常使用',
			31 => 'ec_alipay_checklink_credit',
			32 => '积分充值订单测试',
		),
	),
	163 => 
	array (
		...
		array (
			'电子商务' => 'action=setting&operation=ec',
			'微信支付' => 'action=ec&operation=wechat',
		),
		'text' => 
		array (
			0 => '电子商务 &raquo; 微信支付',
			1 => 'ec_wechat_tips',
			2 => '微信支付（https://pay.weixin.qq.com）是腾讯集团旗下中国领先的第三方支付平台，一直致力于为用户和企业提供安全、便捷、专业的在线支付服务。以“微信支付，不止支付”为核心理念，为个人用户创造了多种便民服务和应用场景，为各类企业以及小微商户提供专业的收款能力，运营能力，资金结算解决方案，以及安全保障。企业、商品、门店、用户已经通过微信连在了一起，让智慧生活，变成了现实。由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用微信支付积分交易功能(不包含支付宝按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您使用微信支付服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，腾讯云不对因使用此功能造成的任何损失承担责任。微信支付客户服务电话为 95017。',
			3 => 'ec_wechat',
			4 => '微信支付设置',
			5 => 'ec_wechat_on',
			6 => '是否启用微信支付',
			...
			18 => 'ec_wechat_v1_key',
			19 => '(必须)API密钥',
			20 => '微信商户平台-->账户设置-->API安全-->密钥设置 - API密钥',
			21 => 'ec_wechat_v1_cert',
			22 => '(可选)支付证书路径',
			23 => 'cert.p12证书的位置；建议修改文件名称，避免被直接访问；退款时用到，如果不办理退款业务，可以不填。必须在网站目录中，如：source/data/{randomstr}.p12',
			24 => 'ec_wechat_v3_key',
			25 => '(必须)APIV3密钥',
			26 => '微信商户平台-->账户设置-->API安全-->密钥设置 - APIv3密钥',
			27 => 'ec_wechat_v3_private_key',
			28 => '(必须)API证书私钥',
			29 => '商户申请/更换商户API证书(微信商户平台-->账户设置-->API安全-->API证书)时，会生成API证书私钥，并保存在本地证书文件夹的文件apiclient_key.pem 中。',
			30 => 'ec_wechat_v3_serial_no',
			31 => '(必须)API证书序列号',
			32 => '在微信商户平台 - 账户中心 - API安全 - API证书 - 查看证书 - 证书序列号',
			33 => 'ec_wechat_check',
			34 => '支付测试',
			35 => 'ec_wechat_version_2',
			36 => 'API',
			37 => 'ec_wechat_version_3',
			38 => 'APIV3',
			39 => 'ec_wechat_php_version_low',
			40 => 'PHP版本过低',
			41 => 'ec_wechat_checklink_credit',
			42 => '积分充值订单测试',
		),
	),
	164 => 
	array (
		...
		array (
			'电子商务' => 'action=setting&operation=ec',
			'QQ 钱包' => 'action=ec&operation=qpay',
		),
		'text' => 
		array (
			0 => '电子商务 &raquo; QQ 钱包',
			1 => 'ec_qpay_tips',
			2 => 'QQ 钱包是腾讯集团财付通旗下的第三方支付平台，一直致力于为用户和企业提供安全、便捷、专业的在线支付服务。由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用 QQ 钱包支付积分交易功能(不包含支付宝按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。请务必正确设置您的收款信息，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。您使用 QQ 钱包服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，腾讯云不对因使用此功能造成的任何损失承担责任。财付通服务热线：0755-83762288-2 (全天 24 小时服务热线) , QQ 钱包客户服务邮箱为 qpay@tencent.com 。',
			3 => 'ec_qpay',
			4 => 'QQ 钱包设置',
			5 => 'ec_qpay_on',
			6 => '是否启用 QQ 钱包支付',
			7 => 'ec_qpay_jsapi',
			8 => '是否启用 QQ 钱包 JSAPI 支付',
			9 => '需要添加经过腾讯审核通过的添加支付授权域名, 如无此权限或打开后无法支付请关闭',
			10 => 'ec_qpay_appid',
			11 => '(可选)应用 ID',
			12 => '腾讯开放平台或 QQ 互联平台审核通过的应用 AppID',
			13 => 'ec_qpay_mch_id',
			14 => '(必须)商户号',
			15 => 'QQ 钱包分配的商户号',
			16 => 'ec_qpay_op_user_id',
			17 => '(可选)操作员 ID',
			18 => '退款时用到的操作员账号, 默认为商户号',
			19 => 'ec_qpay_op_user_passwd',
			20 => '(可选)操作员密码',
			21 => '退款时用到的操作员密码, 系统内使用 md5 编码保存',
			22 => 'ec_qpay_v1_key',
			23 => '(必须)API密钥',
			24 => 'QQ 钱包商户平台 --> 账户管理 --> API 安全',
			25 => 'ec_qpay_v1_cert',
			26 => '(可选)支付证书路径',
			27 => 'cert.p12 证书的位置；建议修改文件名称，避免被直接访问；退款时用到，如果不办理退款业务，可以不填。必须在网站目录中，如：source/data/{randomstr}.p12',
			28 => 'ec_qpay_check',
			29 => '支付测试',
			30 => 'ec_qpay_checklink_credit',
			31 => '积分充值订单测试',
		),
	),
	165 => 
	array (
		...
		array (
			...
			19 => 'ec_orders_search_status_all',
			20 => '全部状态',
			21 => 'ec_orders_search_status_pending',
			22 => '等待付款',
			23 => 'ec_orders_search_status_auto_finished',
			24 => '成功在线支付',
			25 => 'ec_orders_search_status_manual_finished',
			26 => '成功人工补单',
		),
	),
	166 => 
	...
	array (
		...
		array (
			...
			17 => 'forums_cat_display',
			18 => '显示分区',
			19 => '选择“否”将暂时将分区隐藏不显示，但分区内容仍将保留，且用户仍可通过 URL 访问到此分区及其版块',
			20 => 'forums_edit_basic_shownav',
			21 => '在导航显示',
			22 => '选择是否在主导航中显示',
	...
	array (
		...
		array (
			...
			25 => '版块转向 URL',
			26 => '如果设置转向 URL(例如 https://www.discuz.vip)，用户点击本分版块将进入转向中设置的 URL。一旦设定将无法进入版块页面，请确认是否需要使用此功能，留空为不设置转向 URL',
			...
			34 => '绑定别名',
			35 => '绑定后当站点开启 URL 静态化后可通过别名访问此版块，如设置别名为“developer”那么版块的 URL 将变为“forum-developer-1.html”。注意：别名中只能包含字母或数字，且不能是纯数字',
	...
	array (
		...
		array (
			...
			17 => 'forums_edit_extend_widthauto',
			18 => '本版块宽窄风格',
			19 => '设置本版块的显示风格是宽版还是窄版，设置后用户将无法自由切换宽窄风格。默认表示继承全局设置',
			20 => 'forums_edit_extend_picstyle',
			21 => '开启图片列表模式',
			22 => '主题列表将以图片方式显示，主题封面可统一设置宽高',
			23 => 'forums_edit_extend_allowside',
			24 => '显示边栏',
			25 => '选择“是”版块首页侧边将显示聚合本版内容的信息',
			26 => 'forums_edit_extend_recommend_top',
			27 => '显示全局置顶和分类置顶的主题',
			28 => '是否在本版显示全局置顶和分版置顶',
			29 => 'forums_edit_extend_defaultorderfield',
			30 => '主题默认排序字段',
			31 => '设置版块的主题列表默认按照哪个字段进行排序显示。默认为“回复时间”，除默认设置外其他排序方式会加重服务器负担',
			32 => 'forums_edit_extend_defaultorder',
			33 => '主题默认排序方式',
			34 => '设置版块的主题列表默认排序的方式。默认为“按降序排列”，除默认设置外其他排序方式会加重服务器负担',
			35 => 'forums_edit_extend_reply_background',
			36 => '快捷回复框背景图片',
			37 => '设置后将在快速回复框中展现该图片',
			38 => 'forums_edit_extend_threadcache',
			39 => '页面缓存系数',
			...
			47 => 'forums_edit_extend_disablecollect',
			48 => '禁止淘帖',
			49 => '选择“是”将禁止用户淘帖本版主题',
			50 => 'forums_edit_extend_recommend',
			51 => '是否开启推荐主题功能',
			52 => '设置是否开启推荐主题功能',
			53 => 'forums_edit_extend_recommend_sort',
			54 => '版主推荐主题方式',
			55 => '自动生成则按照推荐主题规则设定生成推荐列表。手动生成则由版主自行推荐生成推荐列表。半自动生成则和手动方式类似，当手动生成的列表条数不足设置的显示条数时，将按照推荐主题规则自动补足相差条数',
			56 => 'forums_edit_extend_recommend_orderby',
			57 => '推荐主题规则',
			58 => '推荐主题规则，只对自动和半自动生成推荐主题列表有效，此规则均为降序排列',
			59 => 'forums_edit_extend_recommend_num',
			60 => '推荐主题显示数量',
			61 => '推荐主题显示的数量，默认为 10 条，建议不要超过 20 条',
			62 => 'forums_edit_extend_recommend_imagenum',
			63 => '推荐主题图片附件显示数量',
			64 => '推荐主题中图片附件显示的数量，默认为 5 条。设置为 0 则不显示，建议不要超过 10 条',
			65 => 'forums_edit_extend_recommend_imagesize',
			66 => '推荐主题图片附件显示大小',
			67 => '推荐主题中图片附件显示的大小，默认为 300 x 250',
			68 => 'forums_edit_extend_recommend_maxlength',
			69 => '标题最大字节数',
			70 => '设置当标题长度超过本设定时，是否将标题自动缩减到本设定中的字节数，0 为不自动缩减',
			71 => 'forums_edit_extend_recommend_cachelife',
			72 => '数据缓存时间(秒)',
			73 => '由于一些排序检索操作比较耗费资源，建议设置为 900 的数值',
			74 => 'forums_edit_extend_recommend_dateline',
			75 => '推荐主题时间段',
			76 => '按照设置的排序方式，取从访问推荐主题列表这一刻往前推送时间段内的主题，自动生成推荐主题列表，单位为小时，设置成0为所有时段',
			77 => 'delete',
			78 => '删除',
		),
	),
	...
	array (
		...
		array (
			...
			9 => '成员数',
			10 => 'groups_manage_threadcount',
			11 => '主题数',
			12 => 'groups_manage_replycount',
			13 => '回复数',
			14 => 'groups_manage_createtime',
			15 => '创建时间',
			16 => 'groups_manage_updatetime',
			17 => '最后更新时间',
			18 => 'groups_manage_founder',
			19 => '创建者',
			20 => 'groups_manage_founder_uid',
			21 => '创建者 UID',
		),
	),
	182 => 
	array (
		...
		array (
			...
			3 => 'magics_config_discount',
			4 => '道具回收价格折扣',
			5 => '设置道具系统回收价格折扣，此值为百分比，例如如果此值为 85，则系统将以道具原价 85% 的价格回收，建议不超过 100，有效防止刷积分。留空或者 0 表示不开启道具回收功能',
		),
	),
	183 => 
	array (
		'index' => 
		array (
			'HTML管理' => 'action=makehtml&operation=all',
		),
		'text' => 
		array (
			0 => 'HTML管理',
			...
			3 => 'start_time',
			4 => '起始时间',
			5 => 'makehtml_createall',
			6 => '生成全部',
			7 => 'makehtml_recreate',
			8 => '重新生成',
			9 => 'makehtml_allfilecomplete',
			10 => '全部文件生成完成',
			11 => 'makehtml_waitmaking',
			12 => '请稍等，正在生成首页...',
			13 => 'makehtml_waitmakingcategory',
			14 => '请稍等，正在检查可生成的频道页面...',
			15 => 'makehtml_nofindcategory',
			16 => '没有可生成的频道页面',
			17 => 'makehtml_startmaketopic',
			18 => '现在开始生成专题文件...',
			19 => 'makehtml_browser_error',
			20 => '如果您的浏览器没有反应，请点击继续...',
			21 => 'makehtml_waitchecktopic',
			22 => '请稍等，正在检查可生成的专题页面...',
			23 => 'makehtml_nofindtopic',
			24 => '没有可生成的专题页面',
			25 => 'makehtml_startmakeindex',
			26 => '现在开始生成主页文件...',
			27 => 'makehtml_waitcheckarticle',
			28 => '请稍等，正在检查可生成的文章页面...',
			29 => 'makehtml_nofindarticle',
			30 => '没有可生成的文章页面',
			31 => 'makehtml_startmakecategory',
			32 => '现在开始生成频道文件...',
		),
	),
	184 => 
	...
	array (
		...
		array (
			'HTML管理' => 'action=makehtml',
			'清理HTML' => 'action=makehtml&operation=cleanhtml',
		),
		'text' => 
		array (
			0 => 'HTML管理 &raquo; 清理HTML',
			1 => 'setting_functions_makehtml_cleanhtml',
			2 => '需要清理的HTML',
			3 => '选择需要要清理的HTML',
		),
	),
	...
	array (
		...
		array (
			0 => '勋章中心',
			1 => 'medals_tips',
			2 => '本功能用于设置可以颁发给用户的勋章信息，勋章图片中请填写图片文件名，并将相应图片文件上传到 static/image/common/ 目录中或直接填写图片 URL 地址。',
		),
	),
	187 => 
	array (
	...
	array (
		...
		array (
			...
			18 => '变更理由',
			19 => 'members_group_reason',
			20 => '操作用户的理由',
			21 => '如果您通过用户组设定禁止或解除禁止该用户，请输入操作理由，系统将把理由记录在用户禁止记录中以供日后查看并可选发送给用户。如果并非上述情况且不选择下方的告知用户，可不输入操作理由',
			22 => 'members_group_reason_notify',
			23 => '禁止/解禁用户的理由是否告知用户',
		),
	),
	190 => 
	array (
		...
		array (
			...
			6 => '修改用户积分的理由',
			7 => '如果您修改了用户的积分资料，请输入操作理由，系统将把理由记录在用户评分记录中并可选发送给用户，以供日后查看',
			8 => 'members_credit_reason_notify',
			9 => '修改用户积分的理由是否告知用户',
		),
	),
	191 => 
	...
	array (
		...
		array (
			...
			11 => '解除QQ账号绑定状态',
			12 => '如当前用户的QQ账号丢失或者被盗，可以在这里解除QQ账号的绑定',
			13 => 'members_edit_uinblack',
			14 => '封禁QQ账号',
			15 => '把当前用户的QQ账号封锁，封禁后此QQ账号无法再登录本站点',
			16 => 'members_edit_clearquestion',
			17 => '清除用户安全提问',
			18 => '选择“是”将清除用户安全提问，该用户将不需要回答安全提问即可登录；选择“否”为不改变用户的安全提问设置',
			19 => 'members_edit_status',
			20 => '锁定当前用户',
			21 => 'members_edit_freeze',
			22 => '用户冻结状态',
			23 => 'members_edit_email',
			24 => 'Email',
			25 => 'members_edit_email_emailstatus',
			26 => '邮箱激活状态',
			27 => 'members_edit_secmobile_secmobicc',
			28 => '安全手机国际电话区号',
			29 => 'members_edit_secmobile_secmobile',
			30 => '安全手机号',
			31 => 'members_edit_secmobile_secmobilestatus',
			32 => '安全手机激活状态',
			33 => 'members_edit_posts',
			34 => '发帖数',
			35 => 'members_edit_digestposts',
			36 => '精华帖数',
			37 => 'members_edit_regip',
			38 => '注册 IP',
			39 => 'members_edit_regport',
			40 => '注册端口号',
			41 => 'members_edit_regdate',
			42 => '注册时间',
			43 => 'members_edit_lastvisit',
			44 => '上次访问',
			45 => 'members_edit_lastip',
			46 => '上次访问 IP',
			47 => 'members_edit_port',
			48 => '上次访问端口号',
			49 => 'members_edit_addsize',
			50 => '额外附件容量',
			51 => 'members_edit_addfriend',
			52 => '额外好友数',
			53 => 'members_edit_timeoffset',
			54 => '时差设定',
			55 => '用户本地时间与 GMT 标准的时间差，设置 9999 即为默认时差，和站点设置保持一致',
			56 => 'members_edit_invisible',
			57 => '隐身登录',
			58 => 'members_edit_option',
			59 => '论坛选项',
			60 => 'members_edit_cstatus',
			61 => '自定义头衔',
			62 => 'members_edit_signature',
			63 => '签名',
			64 => 'members_profile',
			65 => '用户栏目',
			66 => 'members_edit_exphistory',
			67 => '用户历史资料下载',
			68 => '历史邮箱、手机号数据请到 UCenter 后台查询',
			69 => 'members_edit',
			70 => '编辑用户',
			71 => 'members_edit_avatar_clear',
			72 => '删除头像',
			73 => 'posts',
			74 => '发帖数',
			75 => 'doings',
			...
			81 => 'shares',
			82 => '分享',
			83 => 'setting_styles_viewthread_userinfo_oltime',
			84 => '在线时间',
			85 => 'hourtime',
			86 => '小时',
			87 => 'members_edit_freeze_false',
			88 => '未冻结',
			89 => 'members_edit_freeze_password',
			90 => '需重置密码后解冻',
			91 => 'members_edit_freeze_admincp',
			92 => '需后台审核后解冻',
			93 => 'members_edit_freeze_email',
			94 => '需验证邮箱或后台审核后解冻',
		),
	),
	193 => 
	array (
		...
		array (
			...
			58 => '用户生日',
			59 => 'members_reward_clean_alarm',
			60 => '您确认要将这些用户所选的积分清零吗？',
			61 => 'yes',
			62 => '是',
			63 => 'no',
			64 => '否',
			65 => 'members_edit_freeze_email',
			66 => '需验证邮箱或后台审核后解冻',
			67 => 'members_edit_freeze_admincp',
			68 => '需后台审核后解冻',
			69 => 'members_edit_freeze_password',
			70 => '需重置密码后解冻',
			71 => 'members_edit_freeze_false',
			72 => '未冻结',
			73 => 'credits',
			74 => '积分',
			75 => 'members_search_between',
			76 => '介于',
			77 => 'year',
			78 => '年',
			79 => 'month',
	...
	array (
		...
		array (
			...
			2 => '此功能仅限极个别特定需求使用，一般站点不需要此功能。因检查操作较慢，所以检查的结果会缓存一天的时间',
		),
	),
	195 => 
	array (
		...
		array (
			0 => '用户分表',
			1 => 'membersplit_tips',
			2 => '此功能仅限极个别特定需求使用，一般站点不需要此功能。请根据服务器性能，适当调整单步处理数。建议在关闭站点下进行分表操作。',
		),
	),
	196 => 
	array (
	...
	array (
		...
		array (
			0 => '词语过滤',
			1 => 'misc_censor_tips',
			2 => '替换前的内容可以使用限定符 {x} 以限定相邻两字符间可忽略的文字，x 是忽略的字节数。如 "a{1}s{2}s"(不含引号) 可以过滤 "ass" 也可过滤 "axsxs" 和 "axsxxs" 等等。对于中文字符，若使用 GBK、Big-5 版本，每个中文字符相当于 2 个字节；若使用 UTF-8 版本，每个中文字符相当于 3 个字节。为不影响程序效率，请不要设置过多不需要的过滤内容。审核只对论坛中的内容有效如果您不是论坛管理员，您将只能对自己添加的项目进行编辑或删除。敏感词如果以"/"(不含引号)开头和结尾则表示格式为正则表达式，这时替换内容可用"(n)"引用正则中的子模式，如"/1\\d{10}([^\\d]+|$)/"替换为"手机(1)"。',
			3 => 'misc_censor_batch_add_tips',
			4 => '每行一组过滤词语，敏感词和替换词之间使用“=”进行分割；如需禁止发布包含某个词语的文字，而不是替换过滤，请将其对应的替换内容设置为{BANNED}即可；如需当用户发布包含某个词语的文字时，自动标记为需要人工审核，而不直接显示或替换过滤，请将其对应的替换内容设置为{MOD}即可(审核只对论坛中的内容有效)。如果只是想将某个词语直接替换成 **，则只输入词语即可；例如：toobadnobadbadword=goodsexword={BANNED}导出/导入时支持词语分类导入，导入时不带有分类则可以通过选择指定导入分类。没有分类时自动归入默认分类',
...
',
	...
	array (
		...
		array (
			0 => '内容重新审核',
			1 => 'remoderate_tips',
			2 => '当词语过滤参数有较大变动或邻近敏感时间点时，可以使用此功能对历史数据进行重新审核。请尽量避开会员访问的高峰时间
				每个循环更新数量：数值请在一个合理范围，不要过大，否则会给服务器带来负载压力
				',
		),
	),
	...
	array (
		...
		array (
			...
			19 => 'setting_basic_mps',
			20 => '联网备案信息代码',
			21 => '页面底部可以显示联网备案信息，如果网站已备案，在此输入您的授权码，它将显示在页面底部，如果没有请留空',
			22 => 'setting_basic_boardlicensed',
			23 => '显示授权信息链接',
			24 => '选择“是”将在页脚显示商业授权用户链接，链接将指向 Discuz! 官方网站，用户可通过此链接验证其所使用的 Discuz! 是否经过商业授权',
			25 => 'setting_basic_stat',
			26 => '网站第三方统计代码',
			27 => '页面底部可以显示第三方统计',
	...
	array (
		...
		array (
			...
			2 => '广播存档时间',
			3 => '广播超过多少天移入存档表(单位：天)',
			4 => 'setting_follow_base_default_follow_add_notice',
			5 => '被关注时通知被关注者',
			6 => '开启后用户被关注时将会收到通知',
			7 => 'setting_follow_base_default_view_profile',
			8 => '默认查看个人资料',
			9 => '该设置对管理员有效，开启后默认管理员查看将直接查看个人资料页面',
		),
	),
	223 => 
	array (
	...
	array (
		...
		array (
			...
			4 => '个人空间首页',
			5 => 'setting_home_privacy_view_profile',
			6 => '个人空间资料',
			...
			18 => '日志',
			19 => '相关浏览权限需要在每篇日志中单独设置方可完全生效',
			20 => 'setting_home_privacy_view_album',
			21 => '相册',
			...
			27 => '默认动态发布设置',
			28 => 'setting_home_privacy_alluser',
			29 => '全站用户可见',
			30 => 'setting_home_privacy_friend',
			31 => '仅好友可见',
			32 => 'setting_home_privacy_self',
			33 => '仅自己可见',
			34 => 'setting_home_privacy_register',
			35 => '仅注册用户可见',
			36 => 'setting_home_privacy_default_feed_doing',
			37 => '记录',
			38 => 'setting_home_privacy_default_feed_blog',
			39 => '撰写日志',
			40 => 'setting_home_privacy_default_feed_upload',
			41 => '上传图片',
			42 => 'setting_home_privacy_default_feed_share',
			43 => '添加分享',
			44 => 'setting_home_privacy_default_feed_poll',
			45 => '发起投票',
			46 => 'setting_home_privacy_default_feed_joinpoll',
			47 => '参与投票',
			48 => 'setting_home_privacy_default_feed_friend',
			49 => '添加好友',
			50 => 'setting_home_privacy_default_feed_comments',
			51 => '发表评论/留言',
			52 => 'setting_home_privacy_default_feed_show',
			53 => '竞价排名',
			54 => 'setting_home_privacy_default_feed_credit',
			55 => '积分消费',
			56 => 'setting_home_privacy_default_feed_spaceopen',
			57 => '新空间开通',
			58 => 'setting_home_privacy_default_feed_invite',
			59 => '邀请好友',
			60 => 'setting_home_privacy_default_feed_task',
			61 => '完成任务',
			62 => 'setting_home_privacy_default_feed_profile',
			63 => '更新个人资料',
			64 => 'setting_home_privacy_default_feed_click',
			65 => '对日志/图片表态',
			66 => 'setting_home_privacy_default_feed_newthread',
			67 => '论坛发帖',
			68 => 'setting_home_privacy_default_feed_newreply',
			69 => '论坛回帖',
		),
	),
	225 => 
	array (
		...
		array (
			...
			24 => '不受邀请码限制的地区列表',
			25 => '当用户处于本列表中的地址时，注册时不受邀请码限制。每个地区一行，例如 "北京"(不含引号)，留空为不设置。注意：如要正确无误的判断您 IP 地址所在的地区，请到网上下载 qqwry.dat IP 地址库文件上传到 "data/ipdata/" 目录下更名为 wry.dat',
			...
			36 => '通过邮件发送注册链接',
			37 => '开启后系统会发一条注册的地址到用户的邮箱，从该地址链接过来的允许注册，同时建议UCenter中开启一个邮箱只允许注册一个账户注意：只有在站长 - 邮件设置中完成邮件设置，确保邮件能发送成功下可以开启该功能 ',
			...
			66 => '同一 IP 注册间隔限制(小时)',
			67 => '同一 IP 在本时间间隔内将只能注册一个账号，0 为不限制',
			...
			72 => '限时注册IP注册间隔限制(小时):',
			73 => '用户处于限时注册的 IP 列表中的 IP 地址时，同一 IP 在本时间间隔内将只能注册一个账号',
			...
			93 => '服务条款内容',
			94 => '网站服务条款的详细内容',
			95 => 'setting_access_register_open',
			96 => '开放普通注册',
			97 => 'setting_access_register_invite',
			98 => '开放邀请注册',
			99 => 'setting_access_register_connect',
			100 => '开放QQ注册',
			101 => 'setting_access_register_strongpw_1',
			102 => '数字',
			103 => 'setting_access_register_strongpw_2',
			104 => '小写字母',
			105 => 'setting_access_register_strongpw_3',
			106 => '大写字母',
			107 => 'setting_access_register_strongpw_4',
			108 => '符号',
			109 => 'none',
			110 => '无',
			111 => 'setting_access_register_verify_email',
			112 => 'Email 验证',
			113 => 'setting_access_register_verify_manual',
			114 => '人工审核',
			115 => 'setting_access_register_maildomain_white',
			116 => '白名单模式',
			117 => 'setting_access_register_maildomain_black',
			118 => '黑名单模式',
			119 => 'setting_access_register_welcomemsg_pm',
			120 => '发送欢迎信息',
			121 => 'setting_access_register_welcomemsg_email',
			122 => '发送欢迎 Email',
		),
	),
	226 => 
	...
	array (
		...
		array (
			...
			35 => 'setting_styles_global_home_style_1',
			36 => '以SNS模块风格展示',
			37 => 'setting_styles_global_home_style_0',
			38 => '以论坛模块风格展示',
			39 => 'setting_styles_global_homepage_style_1',
			40 => '个性化DIY风格',
			41 => 'setting_styles_global_homepage_style_0',
			42 => '论坛样式',
			43 => 'setting_styles_global_navsubhover_0',
			44 => '只显示当前的二级导航',
			45 => 'setting_styles_global_navsubhover_1',
			46 => '显示所有主导航的二级导航',
			47 => 'setting_styles_index_allowwidthauto_1',
			48 => '窄屏(固定宽度)',
			49 => 'setting_styles_index_allowwidthauto_0',
			50 => '宽屏(自由宽度)',
		),
	),
	228 => 
	array (
		...
		array (
			...
			45 => 'setting_styles_index_display_none',
			46 => '不显示',
			47 => 'setting_styles_index_whosonline_index',
			48 => '仅在论坛首页显示',
			49 => 'setting_styles_index_whosonline_forum',
			50 => '仅在论坛版块显示',
	...
	array (
		...
		array (
			...
			15 => 'setting_styles_viewthread_sigimgclick_on',
			16 => '取消签名图片的动态放大功能',
			17 => 'setting_styles_viewthread_rate_on',
			18 => '是否在页面上显示评分理由',
			19 => 'setting_styles_viewthread_rate_number',
			20 => '评分条目数',
			21 => '在帖子中显示最近评分结果的条目数，0 为不显示',
			22 => 'setting_styles_viewthread_collection_number',
			23 => '相关淘专辑条目数',
			24 => '在主题帖中显示相关淘专辑的条目数，0 为不显示',
			25 => 'setting_styles_viewthread_relate_number',
			26 => '相关帖子条目数',
			27 => '在主题帖中显示相关帖子的条目数，0 为不显示',
			28 => 'setting_styles_viewthread_relate_time',
			29 => '相关帖子缓存时间',
			30 => '单位：分钟，在主题帖中显示相关帖子的缓存时间（0 为不缓存，不推荐）',
			31 => 'setting_styles_viewthread_hideattachdown',
			32 => '是否隐藏附件下载次数',
			33 => '开启后贴内图片、附件的下载次数会被隐藏',
			34 => 'setting_styles_viewthread_hideattachtips',
			35 => '是否隐藏附件信息条',
			36 => '开启后贴内图片、附件的提示信息条会被隐藏，开启后无法使用转存到相册功能，如果当前板块是图片列表板块且当前用户有权设置主题封面则此功能无效',
			37 => 'setting_styles_viewthread_show_signature',
			38 => '是否显示作者签名',
			39 => '',
			40 => 'setting_styles_viewthread_show_face',
			41 => '是否显示作者头像',
			42 => '',
			43 => 'setting_styles_viewthread_show_images',
			44 => '是否显示帖内图片',
			45 => '',
			46 => 'setting_styles_viewthread_imagemaxwidth',
			47 => '帖内图片最大宽度',
			48 => '当帖内图片宽度大于设置的值时图片宽度会被自动调节。请填写整数值，不支持百分比数值',
			49 => 'setting_styles_viewthread_imagelistthumb',
			50 => '帖内图片列表中图片横排显示条件',
			51 => '设置当帖内图片列表中图片数量满足多少张以后以横排方式显示，0 或留空为关闭横排显示',
			52 => 'setting_styles_viewthread_zoomstatus',
			53 => '是否使用图片动态放大效果',
			54 => '当帖内图片宽度大于“帖内图片最大宽度”时是否附加鼠标点击时的动态放大效果。选择“是”单击图片会有动态放大效果，选择“否”将会新窗口打开图片',
			55 => 'setting_styles_viewthread_showexif',
			56 => '图片附件显示 EXIF 信息',
			57 => '设置图片附件在动态放大效果中是否显示 EXIF 信息',
			58 => 'setting_styles_viewthread_vtonlinestatus',
			59 => '显示作者在线状态',
			60 => '是否显示帖子作者的在线状态，注意：“精确显示”会轻微加重服务器负担',
			61 => 'setting_styles_viewthread_userstatusby',
			62 => '显示作者的组头衔',
			63 => '设置在帖子中是否显示作者的用户组头衔',
			64 => 'setting_styles_viewthread_postno',
			65 => '帖子顺序单位',
			66 => '设置帖子显示顺序编号的单位，如“#”将显示为 1 #',
			67 => 'setting_styles_viewthread_postnocustom',
			68 => '帖子顺序名称',
			69 => '设置每篇主题所有帖子的顺序名称，每行填写一个名称，第一行代表主题帖，第二行代表主题的第一个回复，以此类推',
			70 => 'setting_styles_viewthread_maxsmilies',
			71 => '最大单一表情解析次数',
			72 => '在一篇帖子中解析的单一表情符号的最大次数，超过此次数限制的表情将不被解析而保留原样，以避免用户在一篇帖子中恶意发表大量表情影响正常阅读，0 为不限制',
			73 => 'setting_styles_viewthread_author_onleft',
			74 => '作者用户名显示位置',
			75 => '显示位置并不会影响论坛的性能和美观，请根据您会员的浏览习惯进行选择',
			76 => 'setting_styles_forumdisplay_disfixedavatar',
			77 => '关闭头像区域固定',
			78 => '当滚动屏幕时，左侧头像区域将跟随右侧帖子内容浮动，填充帖子内容区域很高时导致的左侧空白',
			79 => 'setting_styles_forumdisplay_disfixednv_viewthread',
			80 => '关闭顶部导航固定',
			81 => '当向上滚动屏幕时，主导航将即时出现在屏幕的顶部',
			82 => 'setting_styles_forumdisplay_threadguestlite',
			83 => '游客阅读简化模式',
			84 => '启用后，游客阅读主题时，将不显示用户的具体资料信息。',
			85 => 'setting_styles_viewthread_close_leftinfo',
			86 => '关闭左侧信息栏',
			87 => '帖子左侧用户信息栏是否默认关闭',
			88 => 'setting_styles_viewthread_close_leftinfo_userctrl',
			89 => '左侧信息栏允许用户控制',
			90 => '浏览主题时，用户是否可以控制左侧信息栏的显示状态',
			91 => 'setting_styles_viewthread_guestviewthumb',
			92 => '游客看小图',
			93 => '游客浏览主题时，帖内的图片将以指定大小的小图显示，可提高会员注册数和活跃量',
			94 => 'setting_styles_viewthread_guestviewthumb_width',
			95 => '小图宽度',
			96 => '指定小图的宽度,默认值为100',
			97 => 'setting_styles_viewthread_guestviewthumb_height',
			98 => '小图高度',
			99 => '指定小图的高度，默认值为100',
			100 => 'setting_styles_viewthread_guesttipsinthread',
			101 => '帖内游客登录提示',
			102 => '游客在浏览主题时，在主题的顶部显示提示文字',
			...
			110 => '开启主题帖快速回复',
			111 => '开启后将在主题帖下方展示快速回复框',
			112 => 'setting_styles_viewthread_allow_replybg',
			113 => '开启帖子快速回复框背景',
			114 => '开启后允许给帖子快速回复框添加背景图片',
			115 => 'setting_styles_viewthread_global_reply_background',
			116 => '全局帖子快速回复框背景',
			117 => '设置全局帖子快速回复框背景图片，版块设置优先',
			118 => 'setting_styles_viewthread_display_none',
			119 => '',
			120 => 'setting_styles_viewthread_online_easy',
			121 => '快速显示(推荐使用)',
			122 => 'setting_styles_viewthread_online_exactitude',
			123 => '精确显示',
			124 => 'delete',
			125 => '删除',
		),
	...
	array (
		...
		array (
			...
			1 => 'nav_global',
			2 => '全局',
			3 => 'setting_styles_threadprofile_addplan',
			4 => '添加新方案',
		),
	),
	232 => 
	...
	array (
		...
		array (
			...
			7 => '仅对游客有效',
			8 => '开启此项，则 Rewrite 功能只对游客和搜索引擎有效，可减轻服务器负担',
			9 => 'setting_seo_rewritemobile',
			10 => '触屏版模式 Rewrite',
			11 => '开启此项，则 Rewrite 功能将同时对触屏版有效，可能会影响极少数手机正常工作',
			12 => 'setting_seo_seohead',
			13 => '其他头部信息',
			14 => '如需在 &lt;head&gt;&lt;/head&gt; 中添加其他的 HTML 代码，可以使用本设置，否则请留空',
		),
	),
	236 => 
	array (
		...
		array (
			...
			16 => '缓存系数',
			17 => '页面缓存功能可以将会员经常访问的主题临时缓存起来，缓解大型论坛服务器压力。缓存阈值范围 0 - 100，建议设置为 40 ，0 为关闭。在磁盘空间允许的情况下，适当调高缓存系数，可以提高缓存效果',
	...
	array (
		...
		array (
			...
			23 => 'JS 文件 URL',
			24 => '设置站点 JS 文件的 URL。当设置为缓存目录时，系统会将系统目录中的 *.js 文件进行压缩然后保存到缓存目录以提高读取速度和用户访问速度',
			...
			44 => '系统目录 static/js/',
			45 => 'setting_serveropti_jspath_cache',
			46 => '缓存目录',
			47 => 'setting_serveropti_jspath_custom',
			48 => '自定义 URL',
			49 => 'setting_serveropti_csspath_cache',
			50 => '缓存目录',
			51 => 'setting_serveropti_csspath_custom',
			52 => '自定义 URL',
			53 => 'setting_serveropti_blockcachetimerangepoint',
			54 => '点',
		),
	),
	238 => 
	array (
		...
		array (
			...
			16 => '表情行数',
			17 => '发帖页面表情显示的行数',
			18 => 'setting_editor_mode_discuzcode',
			19 => '纯文本模式',
			20 => 'setting_editor_mode_wysiwyg',
			21 => '所见即所得模式',
			22 => 'setting_editor_simplemode_1',
			23 => '高级',
			24 => 'setting_editor_simplemode_0',
			25 => '常用',
		),
	),
	239 => 
	array (
		...
		array (
			0 => '站点功能 &raquo; 功能模块',
			1 => 'setting_functions_curscript_forum',
			2 => '论坛',
			3 => 'setting_functions_curscript_forum_intro',
			4 => '通过论坛，网站可以给用户提供在线讨论、交流、互动的平台',
			5 => 'setting_functions_curscript_close',
			6 => '关闭',
			7 => 'setting_functions_curscript_open',
			8 => '开启',
			9 => 'setting_functions_curscript_portal',
			10 => '门户',
			...
			18 => '广播',
			19 => 'setting_functions_curscript_follow_intro',
			20 => '收听感兴趣的人，分享有趣的事儿，信息快速传播的利器',
			21 => 'setting_functions_curscript_collection',
			22 => '淘帖',
			23 => 'setting_functions_curscript_collection_intro',
			24 => '网站优质内容的收集与分类，网站内容运营必不可少的好帮手',
			25 => 'setting_functions_curscript_guide',
			26 => '导读',
			27 => 'setting_functions_curscript_guide_intro',
			28 => '自动聚合网站最具争议、最热门、最精华、最新发布等“最”主题',
			29 => 'setting_functions_curscript_feed',
			30 => '动态',
			31 => 'setting_functions_curscript_feed_intro',
			32 => '了解网站关注好友网站动向的直接渠道，让用户不再感觉孤独',
			33 => 'setting_functions_curscript_blog',
			34 => '日志',
			35 => 'setting_functions_curscript_blog_intro',
			36 => '记录每日见闻，分享人生感悟，用户感情宣泄的家园',
			37 => 'setting_functions_curscript_friend',
			38 => '好友',
			39 => 'setting_functions_curscript_friend_intro',
			40 => '结交感兴趣的人，了解感兴趣的事儿，情感快速蔓延的渠道',
			41 => 'setting_functions_curscript_album',
			42 => '相册',
			43 => 'setting_functions_curscript_album_intro',
			44 => '自己的美丽容颜，祖国的大好河山，各种美图的影像档案',
			45 => 'setting_functions_curscript_share',
			46 => '分享',
			47 => 'setting_functions_curscript_share_intro',
			48 => '将网站精华内容推荐给其他网友，形成良好的共享氛围',
			49 => 'setting_functions_curscript_doing',
			50 => '记录',
			51 => 'setting_functions_curscript_doing_intro',
			52 => '分享灵感，表达心情，记录随时想到的人和事儿',
			53 => 'setting_functions_curscript_message',
			54 => '留言板',
			55 => 'setting_functions_curscript_message_intro',
			56 => '通过留言，可以让其他用户不会错过你的互动',
			57 => 'setting_functions_curscript_ranklist',
			58 => '排行榜',
			59 => 'setting_functions_curscript_ranklist_intro',
			60 => '通过排行榜，可以查看本站的相关排行内容',
			61 => 'setting_functions_curscript_task',
			62 => '任务',
			63 => 'setting_functions_curscript_task_intro',
			64 => '缩短用户适应时间，让用户快速融入站点',
			65 => 'setting_functions_curscript_medal',
			66 => '勋章',
			67 => 'setting_functions_curscript_medal_intro',
			68 => '彰显用户在某一方面的特殊贡献，调动用户积极性',
			69 => 'setting_functions_curscript_magic',
			70 => '道具',
			71 => 'setting_functions_curscript_magic_intro',
			72 => '提供丰富多彩的娱乐功能，提升站点交互性和活跃度',
			73 => 'setting_functions_curscript_favorite',
			74 => '收藏',
			75 => 'setting_functions_curscript_favorite_intro',
			76 => '让用户记录喜爱的内容，增加用户留存和用户粘性',
		),
	),
	240 => 
	array (
		...
		array (
			...
			24 => 'setting_functions_mod_reasons_public',
			25 => '是否公开管理操作理由',
			26 => '开启后点击主题帖下方主题操作记录将同时显示管理操作理由',
			27 => 'setting_functions_mod_user_public',
			28 => '是否公开管理操作人员',
			29 => '开启后主题管理操作人员显示为用户的用户名和 UID ，反之主题管理操作人员将只显示为 “管理团队” 而不显示具体信息，同时适用于系统提醒和操作记录',
			30 => 'setting_functions_user_reasons',
			31 => '用户评分理由选项',
			32 => '本设定将在用户执行评分时显示，每个理由一行，如果空行则显示一行分隔符“--------”，用户可选择本设定中预置的理由选项或自行输入',
			33 => 'setting_functions_mod_bannedmessages',
			34 => '隐藏敏感帖子内容',
			35 => '选择相应项目将隐藏被删除或被禁止的用户的相关资料，在相关资料处显示被屏蔽的字样',
			36 => 'setting_functions_mod_warninglimit',
			37 => '用户被警告多少次自动禁言',
			38 => '警告有效期结束自动解除禁言',
			39 => 'setting_functions_mod_warningexpiration',
			40 => '警告有效期(天)',
			41 => '默认为 30 天',
			42 => 'setting_functions_mod_rewardexpiration',
			43 => '悬赏主题有效期',
			44 => '设置悬赏主题的有效天数，当悬赏主题超过有效期后依然未发放悬赏，版主或管理员有权代为主题作者发放悬赏。0 或留空表示不允许版主或管理员进行此操作',
			45 => 'setting_functions_mod_moddetail',
			46 => '版主面板显示审核数目',
			47 => '设置版主面板是否详细显示待审核主题、帖子及用户的具体数目',
			48 => 'setting_functions_mod_bannedmessages_thread',
			49 => '帖子内容',
			50 => 'setting_functions_mod_bannedmessages_avatar',
			51 => '用户头像',
			52 => 'setting_functions_mod_bannedmessages_signature',
			53 => '用户签名',
		),
	),
	241 => 
	...
	array (
		...
		array (
			...
			31 => 'setting_functions_comment_allow_1',
			32 => '直接点评',
			33 => 'setting_functions_comment_allow_2',
			34 => '楼层回复',
		),
	),
	244 => 
	...
	array (
		...
		array (
			...
			1 => 'setting_tips',
			2 => '以红色虚线标示的选项，表示该选项和系统效率、负载能力与资源消耗有关(提高效率、或降低效率)，建议依据自身服务器情况进行调整。',
			3 => 'setting_functions_other_uidlogin',
			4 => '启用UID登录',
			5 => '选择“是”，站点登录时允许通过 UID的方式登录验证',
			6 => 'setting_functions_other_secmobilelogin',
			7 => '启用安全手机号登录',
			8 => '选择“是”，站点登录时允许通过安全手机号或国际电话区号-安全手机号的方式登录验证',
			9 => 'setting_functions_other_autoidselect',
			10 => '启用登录自动选择账号',
			11 => '选择“是”，站点登录时的将自动按 UID、E-mail、用户名的顺序逐一去匹配，其中UID验证只有UID登录方式被启用后才有效',
			12 => 'setting_functions_other_submitlock',
			13 => '启用表单防并发功能',
			14 => '选择“是”，将会防止用户同一时间提交多次表单，可有效防止可能刷分的问题。注意: 在未使用内存缓存(Redis、Memcached)的情况下，本功能可能会加重服务器负担',
			15 => 'setting_functions_other_rssstatus',
			16 => '启用 RSS',
			17 => '选择“是”，将允许用户使用 RSS 客户端软件接收最新的帖子、文章更新。注意: 在分类很多的情况下，本功能可能会加重服务器负担',
			18 => 'setting_functions_other_rssttl',
			19 => 'RSS TTL(分钟)',
			20 => 'TTL(Time to Live) 是 RSS 2.0 的一项属性，用于控制订阅内容的自动刷新时间，时间越短则资料实时性就越高，但会加重服务器负担，通常可设置为 30～180 范围内的数值',
			21 => 'setting_functions_other_oltimespan',
			22 => '用户在线时间更新时长(分钟)',
			23 => 'Discuz! 可统计每个用户总共和当月的在线时间，本设置用以设定更新用户在线时间的时间频率。例如设置为 10，则用户每在线 10 分钟更新一次记录。本设置值越小，则统计越精确，但消耗资源越大。建议设置为 5～30 范围内，0 为不记录用户在线时间',
			24 => 'setting_functions_other_debug',
			25 => '显示程序运行信息',
			26 => '选择“是”将在页脚处显示程序运行时间和数据库查询次数',
			27 => 'setting_functions_other_onlyacceptfriendpm',
			28 => '全站是否默认只接受好友短消息',
			29 => '选择“是”将在个人短消息设置中，默认只接收好友的短消息',
			30 => 'setting_functions_other_pmreportuser',
			31 => '接收短消息举报人(UID，多人使用英文逗号分隔)',
			32 => '根据接收的短消息举报提醒用户，可及时处理发送垃圾短信的用户，留空表示不启用短消息举报功能',
			33 => 'setting_functions_other_at_anyone',
			34 => '发帖时可@任何人',
			35 => '选择否表示，只有被@人在用户的收听列表和好友中时才有效',
			36 => 'setting_functions_other_chatpmrefreshtime',
			37 => '群聊消息内容自动刷新间隔(秒)',
			38 => '用于群聊消息内容刷新, 间隔时间越短对服务器压力越大, 0为不刷新',
			39 => 'setting_functions_other_collectionteamworkernum',
			40 => '淘帖专辑允许共同维护的人数',
			41 => '每个淘帖专辑可以共同参与维护的人数。',
			42 => 'setting_functions_other_shortcut',
			43 => '提醒添加桌面快捷的积分下限',
			44 => '大于等于设置积分的用户将看到添加桌面快捷的顶部提醒，0或不填为关闭此功能',
			45 => 'setting_functions_other_closeforumorderby',
			46 => '关闭主题列表页排序功能',
			47 => '选择“是”用户将只能按默认排序查看，否则，用户自选排序将会增加系统压力。',
			48 => 'setting_functions_other_disableipnotice',
			49 => '关闭登录安全提醒',
			50 => '选择“是”将关闭用户登录地区异常安全提醒功能',
			51 => 'setting_functions_other_darkroom',
			52 => '开启小黑屋',
			53 => '选择“是”将开启小黑屋，用户可以在右下角导航中进入小黑屋，查看被禁言禁止访问用户',
			54 => 'setting_functions_other_global_sign',
			55 => '全局签名内容',
			56 => '该设置必须开启签名后有效，如果用户没有设置签名就显示该签名内容',
		),
	),
	246 => 
	array (
	...
	array (
		...
		array (
			...
			5 => '允许查看哪些版块的帖子',
			6 => '设置允许查看其他用户哪些版块的主题和帖子，可以按住 CTRL 多选',
			...
			11 => '允许查看会员列表',
			12 => 'setting_permissions_minsubjectsize',
			13 => '标题最小字数',
			14 => '论坛、门户、日志均受限制，管理组成员可通过“发帖不受限制”设置而在论坛模块不受影响，0 为不限制',
			15 => 'setting_permissions_maxsubjectsize',
			16 => '标题最大字数',
			17 => '论坛、门户、日志均受限制，管理组成员可通过“发帖不受限制”设置而在论坛模块不受影响, 80 为默认值, 255 为最大值',
			18 => 'setting_permissions_minpostsize',
			19 => '帖子最小字数(字节)',
			20 => '管理组成员可通过“发帖不受限制”设置而不受影响，0 为不限制',
			21 => 'setting_permissions_minpostsize_mobile',
			22 => '手机客户端发帖最小字数(字节)',
			23 => '是否单独为手机客户端设置发帖的最小字节数，0 为不单独设置',
			24 => 'setting_permissions_maxpostsize',
			25 => '帖子最大字数(字节)',
			26 => '管理组成员可通过“发帖不受限制”设置而不受影响',
			27 => 'setting_permissions_alloweditpost',
			28 => '允许用户随时编辑的帖子类型',
			29 => '被选中的帖子类型将不受用户组中的“编辑帖子时间”限制，任何时刻都可以编辑',
			30 => 'setting_permissions_post_append',
			31 => '启用帖子补充功能',
			32 => '启用后，当用户无法编辑自己的帖子时，可以补充内容',
			33 => 'setting_permissions_mailinterval',
			34 => '邮件发送时间间隔',
			35 => '设定邮件发送时间间隔，默认为 300 秒',
			36 => 'setting_permissions_maxpolloptions',
			37 => '投票最大选项数:',
			38 => '设定发布投票包含的最大选项数',
			39 => 'setting_permissions_editby',
			40 => '编辑帖子附加编辑记录',
			41 => '在 60 秒后编辑帖子添加“本帖由 xxx 于 xxxx-xx-xx 编辑”字样。管理员编辑不受此限制',
			42 => 'setting_permissions_profilehistory',
			43 => '启用个人信息历史记录功能',
			44 => '启用后，个人信息历史记录将被保存，可以在后台下载。历史邮箱、安全手机号数据不受此功能限制',
			45 => 'setting_permissions_nsprofiles',
			46 => '个人空间内不展现个人信息',
			47 => '启用后个人空间内将不展现个人信息',
			48 => 'setting_permissions_modasban',
			49 => '不忽略审核关键词',
			50 => '启用后在不支持审核关键词的模块内发现此类关键词将拒绝提交，关闭则允许提交',
			51 => 'nav_setting_rate',
			52 => '评分',
			53 => 'setting_permissions_karmaratelimit',
			54 => '评分时间限制(小时)',
			55 => '帖子发表后超过此时间限制其他用户将不能对此帖评分，版主和管理员不受此限制，0 为不限制',
			56 => 'setting_permissions_modratelimit',
			57 => '版主评分限制',
			58 => '设置版主只能在自身所管辖的版块范围内对帖子进行评分。本限制只对版主有效，允许评分的普通用户及超级版主、管理员不受此限制，因此如果赋予这些用户评分权限，他们仍将可以在全版块范围内进行评分',
			59 => 'setting_permissions_dupkarmarate',
			60 => '允许重复评分',
			61 => '选择“是”将允许用户对一个帖子进行多次评分，默认为“否”',
			62 => 'setting_permissions_editperdel',
			63 => '允许用户编辑帖子时删除帖子',
			64 => '选择“是”将允许用户编辑帖子时删除帖子，默认为“否”',
			65 => 'setting_permissions_hideexpiration',
			66 => '帖子中[hide]标签最大有效天数',
			67 => '距发帖日期天数超过此设置时标签自动失效，0或不填为不限制',
		),
	),
	249 => 
	array (
		...
		array (
			...
			25 => '空间消费使用的积分',
			26 => '设置在空间中消费使用的积分类型',
			27 => 'setting_credits_trans10',
			28 => '回帖奖励使用的积分',
			29 => '当用户发帖时可以设置的回帖奖励所使用的积分',
			30 => 'setting_credits_trans8',
			31 => '用户举报奖惩使用的积分',
			32 => '设置用户举报后对用户奖惩时使用的积分',
			33 => 'setting_credits_trans11',
			34 => '抢楼帖积分限制',
			35 => '参与抢楼帖积分限制时使用的积分',
			...
			55 => '兑换比率为单项积分对应一个单位标准积分的值，例如 extcredits1 的比率为 1.5(相当于 1.5 个单位标准积分)、extcredits2 的比率为 3(相当于 3 个单位标准积分)、extcredits3 的比率为 15(相当于 15 个单位标准积分)，则 extcredits3 的 1 分相当于 extcredits2 的 5 分或 extcredits1 的 10 分。一旦设置兑换比率，则用户将可以在个人中心自行兑换各项设置了兑换比率的积分，如不希望实行积分自由兑换，请将其兑换比率设置为 0',
			56 => 'setting_credits_formula_digestposts',
			57 => '精华帖数',
			58 => 'setting_credits_formula_posts',
			59 => '发帖数',
			60 => 'setting_credits_formula_threads',
			61 => '主题数',
			62 => 'setting_credits_formula_oltime',
			63 => '在线时间(小时)',
			64 => 'setting_credits_formula_friends',
			65 => '好友数',
			66 => 'setting_credits_formula_doings',
			67 => '记录数',
			68 => 'setting_credits_formula_blogs',
			69 => '日志数',
			70 => 'setting_credits_formula_albums',
			71 => '相册数',
			72 => 'setting_credits_formula_sharings',
			73 => '分享数',
			74 => 'setting_credits_formula',
			75 => '总积分计算公式',
			76 => '总积分是衡量用户级别的唯一标准，您可以在此设定用户的总积分计算公式，其中 posts 代表发帖数 (主题 + 回复数)；threads 代表用户发表的主题数；digestposts 代表精华帖数；oltime 代表用户总在线时间(小时)；friends 代表好友数；doings 代表发表的记录数；blogs 代表发表的日志数；albums 代表上传的相册数；sharings 代表发表的分享数；extcredits1～extcredits8 分别代表上述 8 个自定义积分。公式中可使用包括 + - * / () 在内的运算符号',
			77 => 'setting_credits_formula_comment',
			78 => '总积分是衡量用户级别的唯一标准，您可以在此设定用户的总积分计算公式，其中 posts 代表发帖数 (主题 + 回复数)；threads 代表用户发表的主题数；digestposts 代表精华帖数；oltime 代表用户总在线时间(小时)；friends 代表好友数；doings 代表发表的记录数；blogs 代表发表的日志数；albums 代表上传的相册数；sharings 代表发表的分享数；extcredits1～extcredits8 分别代表上述 8 个自定义积分。公式中可使用包括 + - * / () 在内的运算符号',
			79 => 'setting_credits_trans_used',
			80 => '使用交易积分',
			81 => 'setting_credits_trans_credits',
			82 => '使用总积分',
			83 => 'none',
			84 => '无',
		),
	...
	array (
		...
		array (
			...
			2 => '邮件发送方式',
			3 => '如需使用 SSL 加密的 SMTP 发送，请在服务器地址前添加 ssl:// 并调整端口号。',
			4 => 'setting_mail_setting_plugin',
			5 => '插件标识及脚本标识',
			6 => '填写插件的标识符和脚本名称的后半段，用英文冒号隔开',
			7 => 'setting_mail_setting_delimiter',
			8 => '邮件头的分隔符(仅针对PHP sendmail方式有效)',
			9 => '请根据您邮件服务器的设置调整此参数',
			10 => 'setting_mail_setting_includeuser',
			11 => '收件人地址中包含用户名',
			12 => '选择“是”将在收件人的邮件地址中包含站点用户名',
			13 => 'setting_mail_setting_silent',
			14 => '屏蔽邮件发送中的全部错误提示',
			15 => 'setting_mail_setting_send_1',
			16 => '通过 PHP 函数的 sendmail 发送(推荐此方式)',
			17 => 'setting_mail_setting_send_2',
			18 => '通过 SOCKET 连接 SMTP 服务器发送(支持 ESMTP 验证)',
			19 => 'setting_mail_setting_send_3',
			20 => '通过 PHP 函数 SMTP 发送 Email(仅 Windows 主机下有效，不支持 ESMTP 验证)',
			21 => 'setting_mail_setting_send_4',
			22 => '通过插件发送(插件控制发送流程)',
			23 => 'delete',
			24 => '删除',
			25 => 'setting_mail_setting_server',
			26 => 'SMTP 服务器',
			27 => 'setting_mail_setting_port',
			28 => '端口',
			29 => 'setting_mail_setting_timeout',
			30 => '超时(秒)',
			31 => 'setting_mail_setting_edit_addnew',
			32 => '添加新SMTP服务器',
			33 => 'setting_mail_setting_validate',
			34 => '验证',
			35 => 'setting_mail_setting_from',
			36 => '发信人邮件地址',
			37 => 'setting_mail_setting_username',
			38 => 'SMTP 身份验证用户名',
			39 => 'setting_mail_setting_password',
			40 => 'SMTP 身份验证密码',
			41 => 'setting_mail_setting_precedence',
			42 => '优先发送邮件后缀(多个以,分隔)',
			43 => 'setting_mail_setting_delimiter_crlf',
			44 => '使用 CRLF 作为分隔符(通常为 Windows 主机)',
			45 => 'setting_mail_setting_delimiter_lf',
			46 => '使用 LF 作为分隔符(通常为 Unix/Linux 主机)',
			47 => 'setting_mail_setting_delimiter_cr',
			48 => '使用 CR 作为分隔符(通常为 Mac 主机)',
		),
	),
	251 => 
	array (
	...
	array (
		'index' => 
		array (
			'账号保镖' => 'action=setting&operation=sec',
		...
		array (
			...
			8 => '异常登录检测',
			9 => '当用户距离上次登录超过一定期限时，账号会进入未审核组，用户可以通过验证邮箱或者申诉解冻账号，QQ登录的用户不受此功能影响 审核用户',
			10 => 'setting_sec_accountguard_loginoutofdatenum',
			11 => '异常登录检测天数',
			12 => '配置异常登录检测天数，默认值为 90 天',
			13 => 'setting_sec_accountguard_loginpwcheck_none',
			14 => '不开启',
			15 => 'setting_sec_accountguard_loginpwcheck_prompt',
			16 => '开启并提示',
			17 => 'setting_sec_accountguard_loginpwcheck_force',
			18 => '开启并强制修改弱密码',
		),
	),
	253 => 
	...
	array (
		...
		array (
			...
			7 => 'setting_sec_base_need_secmobile',
			8 => '强制用户认证安全手机',
			9 => '选择是的话，用户必须认证自己的安全手机后才能进行发布操作',
			10 => 'setting_sec_base_need_avatar',
			11 => '强制用户上传头像',
			12 => '选择是的话，用户必须设置自己的头像后才能进行发布操作',
			13 => 'setting_sec_base_change_email',
			14 => '禁止用户前台修改邮箱',
			15 => '选择是的话，用户不能通过前台自行修改账号绑定的邮箱',
			16 => 'setting_sec_base_change_secmobile',
			17 => '禁止用户前台修改安全手机',
			18 => '选择是的话，用户不能通过前台自行修改账号绑定的安全手机',
			19 => 'setting_sec_base_need_friendnum',
			20 => '强制用户好友个数',
			21 => '设置用户必须拥有多少个好友后，才可以进行发布操作',
		),
	),
	256 => 
	array (
	...
	array (
		...
		array (
			...
			10 => '发帖不受时间限制的地区列表',
			11 => '当用户处于本列表中的地址时，发帖不受时间段限制。每个地区一行，例如 "北京"(不含引号)，留空为不设置。注意：如要正确无误的判断您 IP 地址所在的地区，请到网上下载 qqwry.dat IP 地址库文件上传到 "data/ipdata/" 目录下更名为 wry.dat',
	...
	array (
		...
		array (
			'上传设置' => 'action=setting&operation=attach',
			'基本设置' => 'action=setting&operation=attach&anchor=basic',
		),
		'text' => 
		array (
			0 => '上传设置 &raquo; 基本设置',
			1 => 'setting_attach_basic_dir',
			2 => '本地附件保存位置',
			3 => '服务器路径，属性 777，必须为 web 可访问到的目录，结尾不加 "/"，相对目录务必以 "./" 开头',
			4 => 'setting_attach_basic_url',
			5 => '本地附件 URL 地址',
			6 => '可为当前 URL 下的相对地址或 http:// 开头的绝对地址，结尾不加 "/"，不能把这个设为远程附件URL地址',
			7 => 'setting_attach_image_lib',
			8 => '图片处理库类型',
			9 => '请选择 Discuz! 用来处理缩略图和水印的图像处理库。GD 是最广泛的处理库但是使用的系统资源较多。ImageMagick 速度快系统资源占用少，但安全性相对较差，且需要服务器安装 ImageMagick 扩展。如果您的服务器有条件安装此程序，请到 http://www.imagemagick.org 下载',
			10 => 'setting_attach_image_gdlimit',
			11 => 'GD 图片像素点上限',
			12 => '设置 GD 图片像素点上限，数值越大需要的服务器内存也越多，超过默认值 16777216 的站点需要在 php.ini 中设置更大的 memory_limit 以适应此配置',
			13 => 'setting_attach_image_thumbquality',
			14 => '缩略图质量',
			15 => '设置图片附件缩略图的质量参数，范围为 0～100 的整数，数值越大结果图片效果越好，但尺寸也越大',
			16 => 'setting_attach_image_disabledmobile',
			17 => '是否生成手机版缩略图',
			18 => '设置是否为每个附件生成手机版的缩略图',
			19 => 'setting_attach_image_preview',
			20 => '预览',
			21 => '无需保存设置即可预览',
			22 => 'setting_attach_image_watermarktype_GD',
			23 => 'GD',
			24 => 'setting_attach_image_watermarktype_IM',
			25 => 'ImageMagick',
		),
	),
	260 => 
	array (
		...
		array (
			...
			5 => '附件 URL 地址、媒体附件播放',
			6 => '开启附件 URL 地址后，上传附件的地址可通过 "attach://aid.ext" 方式在任何帖内引用（不支持附件收费以及阅读权限判定），并支持媒体类附件的直接播放，此项设置需要在 用户组 - 帖子相关 中允许用户组使用多媒体代码，并保证 config_global.php 配置的本地文件读取模式为 1 或 4 方可生效',
			...
			25 => 'setting_attach_image_thumbstatus_none',
			26 => '不启用',
			27 => 'setting_attach_image_thumbstatus_fixnone',
			28 => '小于指定大小、保持比率',
			29 => 'setting_attach_image_thumbstatus_fixwr',
			30 => '与指定大小相同、保持比率，超出部分剪切',
		),
	),
	261 => 
	array (
		...
		array (
			...
			13 => 'FTP 账号',
			14 => '该账号必需具有以下权限：读取文件、写入文件、删除文件、创建目录、子目录继承',
			...
			25 => '远程访问 URL',
			26 => '支持 HTTP 和 FTP 协议，结尾不要加斜杠“/”；如果使用 FTP 协议，FTP 服务器必需支持 PASV 模式，为了安全起见，使用 FTP 连接的账号不要设置可写权限和列表权限',
	...
	array (
		...
		array (
			...
			55 => '预览',
			56 => '请先提交后再预览',
			57 => 'setting_imgwater_image_watermarkstatus_none',
			58 => '不启用水印功能',
			59 => 'setting_imgwater_image_watermarktype_gif',
			60 => 'GIF 类型水印',
			61 => 'setting_imgwater_image_watermarktype_png',
			62 => 'PNG 类型水印',
			63 => 'setting_imgwater_image_watermarktype_text',
			64 => '文本类型水印',
		),
	),
	265 => 
	...
	array (
		...
		array (
			...
			2 => '开启搜索',
			3 => '勾选您要开启的搜索栏目',
			4 => 'setting_search_srchsetting',
			5 => '搜索选项设置',
			6 => 'setting_search_srchcensor',
			7 => '搜索受词语过滤控制',
			8 => 'setting_search_srchhotkeywords',
			9 => '热门关键词',
			10 => '每行一个',
			11 => 'settings_sphinx',
			12 => 'Sphinx 全文检索设置',
			13 => 'settings_sphinx_sphinxon',
			14 => '是否开启',
			15 => '设置是否开启 Sphinx 全文检索功能，开启前确认 Sphinx 安装及配置成功',
			16 => 'settings_sphinx_sphinxhost',
			17 => '设置 Sphinx 主机名，或者 Sphinx 服务 socket 地址',
			18 => '填写 Sphinx 主机名：例如，本地主机填写“localhost”，或者填写 Sphinx 服务 socket 地址，必须是绝对地址：例如，/tmp/sphinx.sock',
			19 => 'settings_sphinx_sphinxport',
			20 => '设置 Sphinx 主机端口',
			21 => '填写 Sphinx 主机端口：例如，3312，主机名填写 socket 地址的，则此处不需要设置',
			22 => 'settings_sphinx_sphinxsubindex',
			23 => '设置标题索引名',
			24 => '填写 Sphinx 配置中的标题主索引名及标题增量索引名：例如，“threads,threads_minute”。注意：多个索引使用半角逗号 "," 隔开，必须按照 Sphinx 配置文件中的索引名填写',
			25 => 'settings_sphinx_sphinxmsgindex',
			26 => '设置全文索引名',
			27 => '填写 Sphinx 配置中的全文主索引名及全文增量索引名：例如，“posts,posts_minute”。注意：多个索引使用半角逗号 "," 隔开，必须按照 Sphinx 配置文件中的索引名填写',
			28 => 'settings_sphinx_sphinxmaxquerytime',
			29 => '设置最大搜索时间',
			30 => '填写最大搜索时间，以毫秒为单位。参数必须是非负整数。默认值为 0，意思是不做限制',
			31 => 'settings_sphinx_sphinxlimit',
			32 => '设置最大返回匹配项数目',
			33 => '填写最大返回匹配项数目，必须是非负整数，默认值10000',
			34 => 'settings_sphinx_sphinxrank',
			35 => '设置全文索引评分模式',
			36 => '(1)SPH_RANK_PROXIMITY_BM25， 默认模式，同时使用词组评分和 BM25 评分，并且将二者结合。[默认]
...
(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	array (
		...
		array (
			...
			12 => 'setting_uc_ip',
			13 => 'UCenter IP 地址',
			14 => '如果您的服务器无法通过域名访问 UCenter 或者想通过指定的本机或内网 IP 直连，可以输入 UCenter 服务器的 IP 地址',
			...
			36 => '头像调用方式',
			37 => '设置用户头像的调用方式，动态方式依靠服务器检测头像的存在情况，静态方式不检测，用户直接请求头像并在失败后加载默认头像。',
			38 => 'setting_uc_dynavt',
			39 => '头像缓存机制',
			40 => '设置用户头像的缓存机制，仅在动态调用模式下生效，可以避免更换头像后无法及时看到的问题，但会增加一些服务器压力。',
			41 => 'setting_uc_connect_mysql',
			42 => '数据库方式',
			43 => 'setting_uc_connect_api',
			44 => '接口方式',
			45 => 'setting_uc_avatarmethod_0',
			46 => '使用动态方式调用头像',
			47 => 'setting_uc_avatarmethod_1',
			48 => '使用静态方式调用头像',
			49 => 'setting_uc_dynavt_0',
			50 => '自动（完全由用户浏览器处理，性能最好）',
			51 => 'setting_uc_dynavt_1',
			52 => '用户自身头像带更新时间戳，其他头像自动',
			53 => 'setting_uc_dynavt_2',
			54 => '全部带更新时间戳（可能会增加服务器压力）',
		),
	),
	269 => 
	array (
		...
		array (
			...
			3 => 'setting_ec_ratio',
			4 => '现金/积分兑换比率',
			5 => '设置真实货币现金(以人民币元为单位)与站点交易积分间的兑换比率，例如设置为 10，则 1 元人民币可以兑换 10 个单位的交易积分。本功能需开启交易积分，并成功进行收款账号的相关设置后方可使用，如果禁止使用现金与交易积分的兑换功能，请设置为 0',
	...
	array (
		...
		array (
			0 => '排行榜设置',
			1 => 'setting_ranklist_index_cache_time',
			2 => '排行榜首页缓存时间',
			3 => '单位：小时',
			...
			10 => '竞价排名功能开启',
			11 => '开启用户模块下竞价排名功能',
			12 => 'setting_ranklist_member_show_announcement',
			13 => '竞价排名功能公告信息',
			14 => '填入竞价排名功能公告信息',
			15 => 'setting_ranklist_block_set',
			16 => '排行榜详细模块设置',
			17 => 'setting_ranklist_update_cache_choose',
			18 => '选择更新缓存模块',
			19 => 'setting_ranklist_block_comment',
			20 => '请根据服务器的负载情况，设置合理的更新时间间隔，建议最少不能低于 5 小时。显示条数越多负载越高，建议最多不要超过100条，默认为 20 条',
			21 => 'setting_ranklist_cache_comment',
			22 => '请根据服务器的负载情况，合理选择需要更新缓存的模块，选的模块越多服务器的负载越高',
		),
	),
	273 => 
	array (
		...
		array (
			'手机版设置' => 'action=setting&operation=mobile',
			'全局设置' => 'action=setting&operation=mobile&anchor=status',
		),
		'text' => 
		array (
			0 => '手机版设置 &raquo; 全局设置',
			1 => 'setting_mobile_status_tips',
			2 => '本手机功能页仅支持WAP2.0(XHTML方式)以上的手机浏览器进行访问。',
			...
			14 => 'setting_mobile_simpletype',
			15 => '开启无图模式',
			16 => '默认显示图片，开启后，“触屏版”不显示帖子图片，“简易版”不显示帖子图片、小图标、主题列表日期等页面元素',
			17 => 'setting_mobile_cachetime',
			18 => '页面浏览缓存时间',
			19 => '设置访问过的页面在用户手机上保存的时间，留空或0为不缓存单位：秒',
			20 => 'setting_mobile_come_from',
			21 => '手机发帖来源自定义',
			22 => '默认留空，如果填写，将在看帖页面"来自手机"处增加自定义文字或图标如:&lt;a href=\'http://m.x.com\'&gt;手机频道&lt;/a&gt;此处支持HTML标签有：&lt;a&gt;&lt;font&gt;&lt;span&gt;&lt;strong&gt;&lt;b&gt;&lt;img&gt;如果使用图标，请保证图片高度在16px(像素)以内',
			23 => 'yes',
			24 => '是',
			25 => 'no',
			26 => '否',
	...
	array (
		...
		array (
			'手机版设置' => 'action=setting&operation=mobile',
			'门户设置' => 'action=setting&operation=mobile&anchor=portal',
		),
		'text' => 
		array (
			0 => '手机版设置 &raquo; 门户设置',
			1 => 'setting_mobile_portal',
			2 => '门户设置',
			3 => 'setting_mobile_portal_catnav',
			4 => '开启首页频道导航',
			5 => '开启后门户首页将显示一级频道作为导航',
		),
	),
	275 => 
	array (
		...
		array (
			'手机版设置' => 'action=setting&operation=mobile',
			'论坛设置' => 'action=setting&operation=mobile&anchor=forum',
		),
		'text' => 
		array (
			0 => '手机版设置 &raquo; 论坛设置',
			1 => 'setting_mobile_forum',
			2 => '论坛设置',
			3 => 'setting_mobile_forum_forumindex',
			4 => '论坛首页样式',
			5 => '选择导读需要开启导读功能；选择首页四格需要开启首页四格功能；',
			6 => 'setting_mobile_forum_statshow',
			7 => '显示统计信息',
			8 => '开启后将在论坛首页顶部显示论坛统计信息，仅在论坛首页样式为论坛版块或论坛版块含首页四格模式下显示',
			9 => 'setting_mobile_forum_displayorder3',
			10 => '是否显示置顶贴',
			11 => '“触屏版”功能，在帖子列表页面中是否显示置顶贴，否为不显示',
			12 => 'setting_mobile_forum_topicperpage',
			13 => '每页显示主题数',
			14 => '主题列表页每页显示主题个数，为空时和界面设置保持一致当此处和界面设置数值不同时会导致手机端和电脑端分页不一致，请谨慎配置',
			15 => 'setting_mobile_forum_postperpage',
			16 => '主题内每页显示帖数',
			17 => '主题内每页显示的帖子数目，为空时和界面设置保持一致当此处和界面设置数值不同时会导致手机端和电脑端分页不一致，请谨慎配置',
			18 => 'setting_mobile_forum_forumview',
			19 => '首页分区展示方式',
			20 => '如“收起”，论坛首页将默认只展示分区标题用户需点击分区展开该分区下的版块列表',
			21 => 'setting_mobile_forum_forumindex_guide',
			22 => '导读',
			23 => 'setting_mobile_forum_forumindex_grid',
			24 => '首页四格',
			25 => 'setting_mobile_forum_forumindex_forumlist',
			26 => '论坛版块',
			27 => 'setting_mobile_forum_forumindex_forumgrid',
			28 => '论坛版块含首页四格',
			29 => 'pack',
			30 => '收起',
			31 => 'unwind',
	...
	array (
		...
		array (
			0 => '防采集设置',
			1 => 'setting_antitheft_tips',
			2 => '防采集功能不影响正常用户浏览检验。可防止本站主题、文章和日志被非法采集。当IP同时存在于黑/白名单时，白名单优先。开启防采集功能后帖子列表页面的帖子预览功能将不可使用。',
			3 => 'setting_antitheft_status',
			4 => '防采集全局设置',
			5 => 'setting_antitheft_allow',
			6 => '是否开启防采集',
			7 => 'setting_antitheft_24_max',
			8 => '每日最大访问量',
			9 => '设置独立IP每日最大访问次数，推荐值200',
			10 => 'setting_antitheft_white',
			11 => '白名单防采集过滤IP',
			12 => '当用户处于本列表中的 IP 地址时，可无限次数访问，不进行防采集过滤。每个 IP 一行，既可输入完整地址，也可只输入 IP 开头，例如 "192.168."(不含引号) 可匹配 192.168.0.0～192.168.255.255 范围内的所有地址，留空为不设置',
			13 => 'setting_antitheft_black',
			14 => '黑名单防采集过滤IP',
			15 => '当用户处于本列表中的 IP 地址时，全部进行防采集过滤。每个 IP 一行，既可输入完整地址，也可只输入 IP 开头，例如 "192.168."(不含引号) 可匹配 192.168.0.0～192.168.255.255 范围内的所有地址，留空为不设置',
			16 => 'setting_antitheft_disable',
			17 => '不进行防采集的内容',
			18 => 'setting_antitheft_addwhitelist',
			19 => '加入白名单',
			20 => 'setting_antitheft_addblacklist',
			21 => '加入黑名单',
			22 => 'delete',
			23 => '删除',
			24 => 'yes',
			...
			26 => 'no',
			27 => '否',
			28 => 'setting_antitheft_disable_thread',
			29 => '主题',
			30 => 'setting_antitheft_disable_article',
			31 => '文章',
			32 => 'setting_antitheft_disable_blog',
			33 => '日志',
		),
	),
	277 => 
	...
	array (
		'index' => 
		array (
			'模板管理' => 'action=styles&operation=edit',
		),
		'text' => 
		array (
			0 => '模板管理',
			1 => 'styles_tips',
			2 => '由于扩展配色会重定义某些风格变量，因此某些风格变量可能只对默认配色有效',
			3 => 'styles_edit_name',
			4 => '界面方案名称',
			5 => '识别界面风格的标志，请勿使用空格或特殊符号',
			6 => 'styles_edit_tpl',
			7 => '匹配模板',
			8 => '与本套界面风格相匹配的模板名称',
			9 => 'styles_edit_extstyle',
			10 => '扩展配色',
			11 => '选择开放给用户自由选择的扩展配色方案要增加新的扩展配色方案，可上传到风格目录的 style/ 文件夹下，如 template/default/style/',
			12 => 'styles_edit_defaultextstyle',
			13 => '默认配色',
			14 => 'styles_edit_smileytype',
			15 => '默认表情分类',
			16 => 'styles_edit_imgdir',
			17 => '界面基础图片目录 {IMGDIR}',
			18 => '风格基础图片存放的目录，留空表示使用 static/image/common/ 目录为基础图片目录',
			19 => 'styles_edit_styleimgdir',
			20 => '扩展图片目录 {STYLEIMGDIR}',
			21 => '风格扩展图片存放的目录，留空表示无扩展图片目录',
			22 => 'styles_edit_logo',
			23 => '站点 Logo {BOARDIMG},{BOARDLOGO}',
			24 => '如使用 Flash 动画，请用逗号隔开 URL、宽度和高度，如“logo.swf,80,40”',
			25 => 'styles_edit_searchlogo',
			26 => '搜索 Logo {SEARCHIMG},{SEARCHLOGO}',
			27 => 'styles_edit_touchlogo',
			28 => '手机触屏版 Logo {TOUCHIMG},{TOUCHLOGO}',
			29 => 'styles_edit_customvariable',
			30 => '自定义模板变量',
			31 => 'styles_edit',
			32 => '编辑风格',
			33 => 'styles_edit_hexcolor',
			34 => '输入 16 进制颜色 #RRGGBB',
			35 => 'styles_edit_bg',
			36 => '输入背景图片地址输入附加属性',
		),
	),
	...
	array (
		...
		array (
			...
			7 => 'delete',
			8 => '删除',
			9 => 'threadsplit_manage_table_add',
			10 => '添加存档表',
			11 => 'threadsplit_manage_forum_update',
			12 => '更新版块存档',
		),
	),
	286 => 
	array (
		...
		array (
			...
			32 => '主题作者',
			33 => '多用户名中间请用半角逗号 "," 隔开',
			34 => 'threads_search_sticky',
			35 => '是否包含置顶帖',
			36 => 'threads_search_digest',
			37 => '是否包含精华帖',
			38 => 'threads_search_attach',
			39 => '是否包含附件',
			40 => 'threads_rate',
			41 => '是否包含评分帖',
			42 => 'threads_highlight',
			43 => '是否包含高亮帖',
			44 => 'threads_list',
			45 => '主题列表',
			46 => 'threadsplit_move_threads_per_time',
			47 => '每次移动主题数',
			48 => '建议不超过 1000',
		),
	),
	...
	array (
		...
		array (
			...
			25 => 'usergroups_edit_basic_allowfollow',
			26 => '允许用户收听他人',
			27 => '设置是否允许用户收听他人，避免收听类骚扰',
			28 => 'usergroups_edit_basic_allowsendpm',
			29 => '允许发送短消息',
			30 => '设置是否允许用户发送短消息',
			31 => 'usergroups_edit_pm_sendpmmaxnum',
			32 => '24小时内发布短消息最大数',
			33 => '设置该用户组用户24小时内发布短消息的最大数，有效的控制短消息发布广告的情况, 0为不限制',
			34 => 'usergroups_edit_pm_sendallpm',
			35 => '是否可以给任何人发短消息',
			36 => '选择否的话，当对方设置为只接受好友短消息，将无法对其发送短消息',
			37 => 'usergroups_edit_post_html',
			38 => '允许使用 HTML 代码',
			39 => '注意: 开放 HTML 功能将产生安全隐患，请慎用。建议只在十分必要的情况下使用，并限制只开放给最核心的管理人员',
			40 => 'usergroups_edit_post_url',
			41 => '允许发站外URL',
			42 => '是否允许发帖包含URL，合理的设置可以有效的减少广告帖的量',
			43 => 'usergroups_edit_basic_allow_statdata',
			44 => '允许查看站点统计',
			45 => 'usergroups_edit_basic_allowavatarupload',
			46 => '允许在本应用上传头像',
			47 => '设置是否允许该用户组在本应用上传头像。注意：本选项与强制用户上传头像同时开启时可能导致用户无法正常发布内容',
			48 => 'usergroups_edit_basic_allowviewprofile',
			49 => '允许用户浏览个人资料页',
			50 => '设置是否允许该用户组浏览其他用户的个人资料页',
			51 => 'usergroups_edit_basic_search_post',
			52 => '允许全文搜索',
			53 => '此设置只对搜索论坛有效。注意: 当数据量大时，全文搜索将非常耗费服务器资源，请慎用',
			54 => 'usergroups_edit_basic_search',
			55 => '允许使用搜索',
			56 => '选择您要为此用户组开启的搜索项目',
			57 => 'usergroups_edit_basic_reasonpm',
			58 => '操作理由短消息通知作者',
			59 => '设置用户在对他人评分或管理操作时是否强制输入理由和通知作者',
			60 => 'usergroups_edit_basic_cstatus',
			61 => '允许自定义头衔',
			62 => '设置是否允许用户设置自己的头衔名字并在帖子中显示',
			63 => 'usergroups_edit_basic_disable_periodctrl',
			64 => '不受时间段限制',
			65 => '设置用户是否可以不受全局设置中设置的特殊时间段禁令限制',
			66 => 'usergroups_edit_basic_hour_threads',
			67 => '会员每小时发主题数限制',
			68 => '设置允许会员每小时最多的发主题数量，可以配合灌水预防功能进一步限制会员的发帖，可设置为 1～255 范围内的数值，0 为不限制。此功能会轻微加重服务器负担，且对游客无效',
			69 => 'usergroups_edit_basic_hour_posts',
			70 => '会员每小时发回帖数限制',
			71 => '设置允许会员每小时最多的发回帖数量，可以配合灌水预防功能进一步限制会员的发帖，可设置为 1～255 范围内的数值，0 为不限制。此功能会轻微加重服务器负担，且对游客无效',
			72 => 'usergroups_edit_basic_seccode',
			73 => '启用验证码或验证问答机制',
			74 => '开启验证机制可以防止灌水机等，但会增加用户操作易用度。修改密码不受此限制，开启验证码或验证问答后，该设置有效',
			75 => 'usergroups_edit_basic_forcesecques',
			76 => '强制设置安全提问',
			77 => '选择“是”则此用户组的用户在登录后台前必须设置安全提问后才可登录后台, config中为全局开关',
			78 => 'usergroups_edit_basic_forcelogin',
			79 => '安全登录方式',
			80 => '选择此用户组用户安全登录的方式',
			81 => 'usergroups_edit_basic_disable_postctrl',
			82 => '发表不受限制',
			83 => '设置发表是否不受灌水预防和最大字数等',
			84 => 'usergroups_edit_basic_ignore_censor',
			85 => '忽略需要审核的关键字',
			86 => '选择“是”则此用户组的用户在发表时不会触发需要审核的关键字',
			87 => 'usergroups_edit_basic_allowcreatecollection',
			88 => '允许用户创建淘专辑的数量',
			89 => '“0”表示不允许创建淘专辑',
			90 => 'usergroups_edit_basic_allowfollowcollection',
			91 => '最多允许关注淘专辑的数量',
			92 => '允许用户最多关注淘专辑的数量',
			93 => 'usergroups_edit_basic_close_ad',
			94 => '是否关闭广告展示',
			95 => '选择“是”则此用户组的用户在站点中看不到任何广告',
			96 => 'delete',
			97 => '删除',
			98 => 'usergroups_edit_post_url_banned',
			99 => '禁止发表',
			100 => 'usergroups_edit_post_url_mod',
			101 => '允许，但帖子进入审核',
			102 => 'usergroups_edit_post_url_unhandle',
			103 => '允许，但不解析',
			104 => 'usergroups_edit_post_url_enable',
			105 => '允许，并正常解析',
			106 => 'usergroups_edit_basic_reasonpm_none',
			107 => '不强制',
			108 => 'usergroups_edit_basic_reasonpm_reason',
			109 => '强制输入理由',
			110 => 'usergroups_edit_basic_reasonpm_pm',
			111 => '强制通知作者',
			112 => 'usergroups_edit_basic_reasonpm_both',
			113 => '强制输入理由和通知作者',
			114 => 'usergroups_edit_basic_forcelogin_none',
			115 => '不开启',
			116 => 'usergroups_edit_basic_forcelogin_qq',
			117 => 'QQ登录',
			118 => 'usergroups_edit_basic_forcelogin_mail',
			119 => '邮箱登录',
		),
	),
	291 => 
	...
	array (
		...
		array (
			...
			66 => 'usergroups_edit_post_allowsave',
			67 => '允许保存草稿',
			68 => '设置是否允许用户保存草稿',
			69 => 'usergroups_edit_post_allowsavereply',
			70 => '允许回复草稿',
			71 => '设置是否允许用户回复草稿（回复草稿不增加用户积分，但增加用户发帖数）',
			72 => 'usergroups_edit_post_allowsavenum',
			73 => '允许保存草稿的数量',
			74 => '设置为 0 为不限制用户保存草稿的数量（高流量站点不建议限制草稿数）',
			75 => 'usergroups_edit_post_allowsetpublishdate',
			76 => '允许设置定时发布',
			77 => '允许用户在发布主题时设置指定的发帖时间。只能设置在每半小时（如 13:00 或 13:30）自动发布。',
			...
			85 => '附件相关',
			86 => 'usergroups_edit_attach_get',
			87 => '允许下载附件',
			88 => '设置是否允许在没有设置特殊权限的论坛中下载附件',
			89 => 'usergroups_edit_attach_getimage',
			90 => '允许查看图片',
			91 => '设置是否允许在没有设置特殊权限的论坛中查看图片',
			92 => 'usergroups_edit_attach_post',
			93 => '允许上传附件',
			94 => '设置是否允许上传附件到没有设置特殊权限的论坛中。需要 PHP 设置允许才有效，请参考管理中心首页',
			95 => 'usergroups_edit_attach_set_perm',
			96 => '允许设置附件权限',
			97 => '设置是否允许设置附件需要指定积分以上才可下载',
			98 => 'usergroups_edit_image_post',
			99 => '允许上传图片',
			100 => '设置是否允许上传图片到没有设置特殊权限的论坛中。需要 PHP 设置允许才有效，请参考管理中心首页',
			101 => 'usergroups_edit_attach_max_size',
			102 => '论坛最大附件尺寸(单位K 1M=1024K)',
			103 => '设置附件最大尺寸(单位K 1M=1024K)，0 为不限制，需要 PHP 设置允许才有效，请参考管理中心首页',
			104 => 'usergroups_edit_attach_max_size_per_day',
			105 => '每天最大附件总尺寸(单位K 1M=1024K)',
			106 => '设置用户每天可以上传的附件总量(单位K 1M=1024K)，0 为不限制',
			107 => 'usergroups_edit_attach_max_number_per_day',
			108 => '每天最大附件数量',
			109 => '设置用户每天可以上传的附件数量，0 为不限制',
			110 => 'usergroups_edit_attach_ext',
			111 => '允许附件类型',
			112 => '设置允许上传的附件扩展名，多个扩展名之间用半角逗号 "," 隔开，留空为不限制',
			113 => 'usergroups_edit_post_direct_none',
			114 => '全部需要审核',
			115 => 'usergroups_edit_post_direct_reply',
			116 => '发新回复不需要审核',
			117 => 'usergroups_edit_post_direct_thread',
			118 => '发新主题不需要审核',
			119 => 'usergroups_edit_post_direct_all',
			120 => '全部不需要审核',
			121 => 'usergroups_edit_post_allowcommentpost_firstpost',
			122 => '点评主题',
			123 => 'usergroups_edit_post_allowcommentpost_reply',
			124 => '点评回复',
		),
	),
	293 => 
	array (
		...
		array (
			...
			12 => 'usergroups_edit_magic_unallowed',
			13 => '不允许使用、购买和转让',
			14 => 'usergroups_edit_magic_allow',
			15 => '允许使用、购买',
			16 => 'usergroups_edit_magic_allow_and_pass',
			17 => '允许使用、购买和转让',
		),
	),
	294 => 
	...
	array (
		...
		array (
			...
			14 => '允许参与评分',
			15 => 'usergroups_edit_credit_exempt_outperm',
			16 => '管辖版块外',
			17 => 'usergroups_edit_credit_exempt_inperm',
			18 => '管辖版块内',
			19 => 'usergroups_edit_credit_exempt_comment',
			20 => '以上项目中，选择“是”表示本组用户将不执行相应的扣积分操作，选择“否”将使用论坛默认或版块设定的规则',
			21 => 'name',
			22 => '名称',
			23 => 'usergroups_edit_credit_rate_tips',
			24 => '当选中扣除自身积分后，前台用户评分时会扣除用户的相应积分，否则扣除的系统积分',
		),
	),
	296 => 
	array (
		...
		array (
			...
			24 => '发布分享需要审核',
			25 => 'usergroups_edit_home_allow_comment',
			26 => '发表留言/评论',
			27 => 'usergroups_edit_home_allow_comment_mod',
			28 => '留言/评论评论需要审核',
			29 => '设置此用户组发表留言/评论强制审核，关闭时仅命中审核敏感词时才审核',
			30 => 'usergroups_edit_home_allow_poke',
			31 => '允许打招呼',
			32 => 'usergroups_edit_home_allow_friend',
			33 => '允许加好友',
			34 => 'usergroups_edit_home_allow_click',
			35 => '允许表态',
			36 => 'usergroups_edit_home_allow_space_diy_html',
			37 => '允许自定义模块使用 HTML',
			38 => '注意: 开放 HTML 功能将产生安全隐患，请慎用。建议只在十分必要的情况下使用，并限制只开放给最核心的管理人员',
			39 => 'usergroups_edit_home_allow_space_diy_bbcode',
			40 => '允许自定义模块使用 BBCODE',
			41 => '设置是否解析个人主页自定义模块中的 BBCODE 代码',
	...
	array (
		...
		array (
			...
			12 => '允许发站外URL',
			13 => 'usergroups_edit_post_direct_none',
			14 => '全部需要审核',
			15 => 'usergroups_edit_post_direct_reply',
			16 => '发新回复不需要审核',
			17 => 'usergroups_edit_post_direct_thread',
			18 => '发新主题不需要审核',
			19 => 'usergroups_edit_post_direct_all',
			20 => '全部不需要审核',
			21 => 'usergroups_edit_post_url_banned',
			22 => '禁止发表',
			23 => 'usergroups_edit_post_url_mod',
			24 => '允许，但帖子进入审核',
			25 => 'usergroups_edit_post_url_unhandle',
			26 => '允许，但不解析',
			27 => 'usergroups_edit_post_url_enable',
			28 => '允许，并正常解析',
		),
	),
	298 => 
	array (
		...
		array (
			...
			6 => 'usergroups_edit_portal_allow_comment_article_mod',
			7 => '文章评论需要审核',
			8 => '设置此用户组发表文章评论强制审核，关闭时仅命中审核敏感词时才审核',
			9 => 'usergroups_edit_portal_allow_post_article',
			10 => '发布文章',
			11 => 'usergroups_edit_portal_allow_down_local_img',
			12 => '允许下载本地图片',
