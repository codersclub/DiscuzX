...
$lang = array (
  ...
  'grouptype_delete_sub_notnull' => '存在下级分类，请先返回删除本分类或分类的下级圈子',
  ...
  'robots_output' => '请下载此文件，并上传至您站点的根目录下 <a href="{siteurl}robots.txt" target="_blank">{siteurl}robots.txt</a> 位置处，如已存在其他内容的同名文件请自行合并。',
  ...
  'cloudaddons_batch_succeed' => '请分别点击下面的链接进行安装及升级操作',
  ...
  'counter_groupmember_num_succeed' => '圈子成员数重建完成',
  'counter_groupmember_post_succeed' => '圈子成员发帖数重建完成',
  'counter_groupnum_succeed' => '分类圈子数重建完成',
  ...
  'database_export_dos8p3_failed' => '服务器开启了 DOS 8.3 文件名支持，为避免可能发生的数据库爆破风险，不允许在线备份数据库',
  ...
  'database_export_succeed' => '数据成功备份至服务器 <a href="{filename}">{filename}</a> 中<br /><br /><font color="red">出于安全考虑，我们强烈建议您下载数据库备份文件后删除文件或设置文件不可通过 URL 访问。</font>{deletetips}',
  ...
  'group_status_off' => '请先开启圈子功能，现在转到圈子设置页',
  'group_update_succeed' => '圈子分类设置更新成功 ',
  'grouptype_delete_succeed' => '圈子分类删除成功 ',
  'grouptype_delete_confirm' => '本操作不可恢复，您确定要删除该分类，清除其中帖子和附件吗？<br />注意：删除圈子并不会更新用户发帖数和积分',
  'grouptype_delete_alarm' => '本操作不可恢复，正在删除圈子数据...',
  'group_name_exist' => '该圈子名称已经存在',
  'group_edit_succeed' => '圈子编辑成功 ',
  'group_thread_removing' => '正在删除圈子内的帖子，请勿关闭浏览器！',
  'group_delete_succeed' => '圈子删除成功 ',
  'group_changetype_succeed' => '圈子分类调整成功 ',
  'group_merge_continue' => '正在合并第{m}个圈子，还有{n}个，请勿关闭浏览器！',
  'group_mergegroup_succeed' => '圈子合并成功 ',
  'group_optype_no_choice' => '没有选择操作类型',
  'group_newtypeid_no_choice' => '没有选择圈子分类',
  'group_targetgroup_no_choice' => '没有填写目标圈子ID',
  'group_targetgroup_repeat' => '目标圈子与被合并圈子重复',
  'group_targetid_error' => '目标ID错误',
  'group_delete_confirm' => '删除圈子操作不可恢复，确认要删除吗？',
  'group_changetype_confirm' => '确认要将所选圈子移动到分类 <font class="highlight">[{targetname}]</font> 下吗？',
  'group_mergegroup_confirm' => '合并圈子操作不可恢复，确认要合并到圈子 <font class="highlight">[{targetname}]</font> 吗？',
  'group_group_no_choice' => '没有选择要操作的圈子',
  'group_userperm_succeed' => '操作成功 ',
  'group_level_update_credits_invalid' => '缺少积分下限为负数或 0 的圈子等级',
  'group_level_update_credits_duplicate' => '圈子等级积分下限设置重复',
  'group_level_succeed_except_all_levels' => '操作失败，不允许删除除所有的圈子等级',
  'group_level_update_succeed' => '圈子等级更新成功。如您添加了新的等级，<br />请不要忘记修改其相应的设置',
  'group_level_noexist' => '圈子等级不存在',
  'group_mergetype_confirm' => '合并圈子操作不可恢复，确认要合并吗？',
  'group_mergetype_target_error' => '目标分类错误',
  'group_mergetype_succeed' => '分类合并成功 ',
  'group_mod_succeed' => '圈子审核成功 ',
