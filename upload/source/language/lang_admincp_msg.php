...
$lang = array (
  ...
  'database_export_multivol_succeed' => '恭喜您，成功创建 {volume} 个备份文件，备份全部完成。<br /><br /><font color="red">出于安全考虑，我们强烈建议您下载数据库备份文件后在恢复页面删除数据库数据库备份文件或设置数据库备份文件不可通过 URL 访问，以保证网站安全。</font><br /><br />{filelist}',
  'database_export_zip_succeed' => '数据成功备份并压缩至服务器 <a href="{filename}">{filename}</a> 中<br /><br /><font color="red">出于安全考虑，我们强烈建议您下载数据库备份文件后在恢复页面删除数据库数据库备份文件或设置数据库备份文件不可通过 URL 访问，以保证网站安全。</font>',
  ...
  'database_export_succeed' => '数据成功备份至服务器 <a href="{filename}">{filename}</a> 中<br /><br /><font color="red">出于安全考虑，我们强烈建议您下载数据库备份文件后在恢复页面删除数据库数据库备份文件或设置数据库备份文件不可通过 URL 访问，以保证网站安全。</font>',
