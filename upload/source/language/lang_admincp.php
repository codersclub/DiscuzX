...
(
	...
	'nav_maint_threads_group' => '圈子主题管理',
	'nav_recyclebin' => '主题回收站',
	'nav_recyclebinpost' => '回帖回收站',
	'nav_prune' => '论坛批量删帖',
	'nav_prune_group' => '圈子批量删帖',
	'nav_doing' => '记录管理',
	'nav_blog' => '日志管理',
	...
	'setting_access_register_ctrl_comment' => '同一 IP 在本时间间隔内将只能注册一个账号，0 为不限制',
	...
	'setting_access_register_ipctrl_time_comment' => '用户处于限时注册的 IP 列表中的 IP 地址时，同一 IP 在本时间间隔内将只能注册一个账号',
	'setting_access_register_ipctrl' => '限时注册的 IP 列表',
	'setting_access_register_ipctrl_comment' => '当用户处于本列表中的 IP 地址时，在限时注册IP注册间隔限制内将至多只允许注册一个账号。每个 IP 一行，既可输入完整地址，也可只输入 IP 开头，例如 "192.168."(不含引号) 可匹配 192.168.0.0～192.168.255.255 范围内的所有地址，留空为不设置',
	...
	'setting_access_register_connect_uinlimit' => '同一QQ账号最多可创建论坛账号的个数',
	'setting_access_register_connect_uinlimit_comment' => '一个QQ账号无论绑定/解绑多少次，通过此QQ账号最多可以创建论坛新账号的个数，0 或留空为不限制',
	...
	'setting_styles_viewthread_userinfo_posts' => '回帖',
	...
	'setting_styles_viewthread_hideattachdown' => '是否隐藏附件下载次数',
	'setting_styles_viewthread_hideattachdown_comment' => '开启后贴内图片、附件的下载次数会被隐藏',
	'setting_styles_viewthread_hideattachtips' => '是否隐藏附件信息条',
	'setting_styles_viewthread_hideattachtips_comment' => '开启后贴内图片、附件的提示信息条会被隐藏，开启后无法使用转存到相册功能，如果当前板块是图片列表板块且当前用户有权设置主题封面则此功能无效',
	...
	'setting_domain_allow_group' => '开启圈子二级域名',
...
',
	...
	'setting_seo_group' => '圈子首页/分类',
	'setting_seo_group_tips' => '<li>站点名称&nbsp;<font class="highlight">{bbname}</font>（应用范围：所有位置）</li><li>当前圈子名称&nbsp;<font class="highlight">{forum}</font>（应用范围：除圈子首页、分类页）</li><li>一级分类名称&nbsp;<font class="highlight">{first}</font>（应用范围：所有位置）</li><li>二级分类名称&nbsp;<font class="highlight">{second}</font>（应用范围：所有位置）</li><li>当前圈子简介&nbsp;<font class="highlight">{gdes}</font>（应用范围：圈子和圈子帖子页）</li><li>帖子标题&nbsp;<font class="highlight">{subject}</font>（应用范围：圈子帖子页）</li><li>主题摘要&nbsp;<font class="highlight">{summary}</font>（应用范围：圈子帖子页）</li><li>主题标签&nbsp;<font class="highlight">{tags}</font>（应用范围：圈子帖子内容页）</li><li>分页数&nbsp;<font class="highlight">{page}</font>（应用范围：主题列表页、帖子内容页）</li>',
	'setting_seo_grouppage' => '单一圈子页面',
	'setting_seo_viewthread_group' => '圈子帖子内容',
	...
	'setting_seo_code_group_forum' => '当前圈子名称',
	'setting_seo_code_group_first' => '一级分类名称',
	'setting_seo_code_group_second' => '二级分类名称',
	'setting_seo_code_grouppage_forum' => '当前圈子名称',
	'setting_seo_code_grouppage_first' => '一级分类名称',
	'setting_seo_code_grouppage_second' => '二级分类名称',
	'setting_seo_code_grouppage_gdes' => '当前圈子简介',
	'setting_seo_code_grouppage_page' => '圈子主题列表分页数',
	'setting_seo_code_viewthread_group_forum' => '当前圈子名称',
	'setting_seo_code_viewthread_group_first' => '一级分类名称',
	'setting_seo_code_viewthread_group_second' => '二级分类名称',
	'setting_seo_code_viewthread_group_gdes' => '当前圈子简介',
	...
	'setting_seo_rewritestatus_group_group' => '圈子主题列表页',
	...
	'setting_functions_curscript_scriptclosed_group' => '是否开启圈子功能',
	'setting_functions_curscript_scriptclosed_group_comment' => '关闭圈子后，圈子相关的所有功能将不能使用',
	...
	'setting_functions_curscript_group' => '圈子',
	...
	'setting_functions_heatthread_tips' => '<li>主题热度将按参与人次计算，包括回帖，点评，收藏，分享，评分，推荐</li>',
	...
	'setting_permissions_allowviewuserthread_forum_group' => '所有版块和圈子',
	...
	'setting_sec_accountguard_loginoutofdate_comment' => '当用户距离上次登录超过一定期限时，账号会进入未审核组，用户可以通过验证邮箱或者申诉解冻账号，QQ登录的用户不受此功能影响 <a href="'.ADMINSCRIPT.'?action=moderate&operation=members">审核用户</a>',
	...
	'setting_attach_basic_allowattachurl_comment' => '开启附件 URL 地址后，上传附件的地址可通过 "attach://aid.ext" 方式在任何帖内引用<b>（不支持附件收费以及阅读权限判定）</b>，并支持媒体类附件的直接播放，此项设置需要在 <a href="'.ADMINSCRIPT.'?action=usergroups">用户组</a> - 帖子相关 中允许用户组使用多媒体代码，并保证 config_global.php 配置的本地文件读取模式为 1 或 4 方可生效',
	...
	'setting_attach_remote_ftp_user' => 'FTP 账号',
	'setting_attach_remote_ftp_user_comment' => '该账号必需具有以下权限：读取文件、写入文件、删除文件、创建目录、子目录继承',
	...
	'setting_attach_remote_url_comment' => '支持 HTTP 和 FTP 协议，结尾不要加斜杠“/”；如果使用 FTP 协议，FTP 服务器必需支持 PASV 模式，为了安全起见，使用 FTP 连接的账号不要设置可写权限和列表权限',
	...
	'setting_ftp_remote_-103' => '尝试登录到 FTP 服务器失败，请检查 FTP 账号密码设置是否正确',
	'setting_ftp_remote_-104' => '尝试切换目录失败，请检查站点目录设置是否正确',
	'setting_ftp_remote_-105' => '尝试创建目录失败，请检查站点目录设置是否正确，并检查 FTP 账号是否具有创建目录的权限',
	'setting_ftp_remote_-106' => '尝试上传文件失败，请检查站点目录是否具有上传文件的权限',
	'setting_ftp_remote_-107' => '尝试上传文件失败，请检查 FTP 账号是否具有上传文件的权限，如果确认权限正常，请尝试使用被动模式(pasv)连接',
	...
	'setting_attach_remote_-103' => '尝试登录到 FTP 服务器失败，请检查 FTP 账号密码设置是否正确',
	'setting_attach_remote_-104' => '尝试切换目录失败，请检查远程附件目录设置是否正确',
	'setting_attach_remote_-105' => '尝试创建目录失败，请检查远程附件目录设置是否正确，并检查 FTP 账号是否具有创建目录的权限',
	'setting_attach_remote_-106' => '尝试上传文件失败，请检查站点附件目录是否具有上传文件的权限',
	'setting_attach_remote_-107' => '尝试上传文件失败，请检查 FTP 账号是否具有上传文件的权限，如果确认权限正常，请尝试使用被动模式(pasv)连接',
	'setting_attach_remote_wtferr' => '尝试写入临时文件失败，请检查本地是否有写入文件权限',
	'setting_attach_remote_geterr' => '尝试下载文件失败，请检查远程访问 URL 设置是否正确',
	'setting_attach_remote_delerr' => '尝试删除文件失败，请检查 FTP 账号是否具有删除文件的权限',
	...
	'setting_search_status_group' => '搜索圈子',
...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'setting_ranklist_ignorefid' => '不参与排行的版块/圈子',
	'setting_ranklist_ignorefid_comment' => '填入版块ID或圈子ID，对应版块及下面的主题将不进入排行榜，多个版块ID间请用半角逗号 "," 隔开',
	...
	'setting_mobile_portal_wzlist_comment' => '选“是”将显示门户频道文章的聚合列表',
	...
	'setting_uc_connect_comment' => '采用接口方式时，站点和 Ucenter 通信采用远程方式，数据库方式需要您站点可以连接 UCenter 数据库',
	...
	'setting_uc_dynavt_1' => '用户自身头像带更新时间戳，其他头像自动',
	'setting_uc_dynavt_2' => '全部带更新时间戳（可能会增加服务器压力）',
	...
	'nav_nav_mynav' => '快捷导航',
	'nav_nav_topnav' => '顶部导航',
	'nav_nav_mfindnav' => '手机发现页导航',
	'nav_mfindnav_add' => '添加发现页导航',
	...
	'members_search_group_fid' => '圈子 ID(多个圈子逗号分隔)',
	'members_search_verify' => '认证',
	'members_search_conisbind' => '是否绑定QQ',
	'members_search_uinblacklist' => 'QQ账号是否被封',
	...
	'founder_perm_group_editgroup' => '编辑圈子',
	'founder_perm_group_deletegroup' => '删除圈子',
	'founder_perm_group_deletegroupcomments' => '被选中圈子所有数据将被删除',
	'founder_perm_ec_qpay' => 'QQ 钱包账号',
	'founder_perm_ec_wechat' => '微信账号',
	'founder_perm_ec_alipay' => '支付宝账号',
	...
	'usergroups_edit_group' => '圈子相关',
	'usergroups_edit_group_build' => '允许建立圈子的数量',
	'usergroups_edit_group_build_comment' => '范围1-255，0为不允许建立圈子',
	'usergroups_edit_group_buildcredits' => '创建圈子消耗积分',
	'usergroups_edit_group_buildcredits_comment' => '创建圈子需要消耗和积分数量，0为不需要积分',
	...
	'groups_search_result' => '共搜索到<strong> {groupnum} </strong>个符合条件的圈子',
	'groups_setting_basic' => '基本设置',
	'groups_setting_basic_status' => '是否开启圈子功能',
	'groups_setting_basic_mod' => '审核新圈子',
	'groups_setting_basic_mod_comment' => '管理员建立圈子时不需要审核',
	'groups_setting_basic_iconsize' => '圈子图标文件大小(单位：KB)',
	'groups_setting_basic_iconsize_comment' => '设置圈子图标文件的最大尺寸，0 或留空为不限制',
	'groups_setting_basic_recommend' => '推荐圈子',
	'groups_setting_basic_recommend_comment' => '填写要推荐到圈子首页的圈子 ID，以半角逗号 "," 隔开，最多显示 8 个，如不足8个会自动补充积分最高的圈子。例：“23,56,983”',
	'groups_setting_admingroup' => '选择管理用户组(在圈子中具有与论坛中相对应的管理权限)',
	...
	'groups_type_count' => '圈子数',
	'groups_type_operation' => '操作',
	'groups_type_show_rows' => '圈子横排：',
	'groups_type_delete' => '删除本分类及分类下所有圈子',
	'groups_type_search' => '搜索圈子',
	'groups_manage_name' => '圈子名称',
	'groups_manage_id' => '圈子 ID',
	...
	'threads_forumstick' => '版块/圈子置顶',
	'threads_forumstick_tips' => '<li>多版块置顶功能可让一个主题在任意多个版块或圈子分类内置顶显示。</li><li>管理员只需指定主题帖的 URL 地址，并选择要在哪些版块或圈子分类中置顶该主题即可。</li>',
	...
	'threads_forumstick_targets_change' => '更改目标版块/圈子分类',
	'threads_forumstick_targetgroups' => '选择目标圈子分类',
	'threads_forumstick_targetgroups_comment' => '指定的主题会在这些圈子分类的群中置顶显示，可以按住 CTRL 多选',
	'threads_forumstick_forum' => '论坛版块',
	'threads_forumstick_group' => '圈子分类',
	...
	'moderate_members_tips' => '<li>本功能仅在“新用户注册验证”中设置为“人工审核”时或者开启账号保镖时才有效</li>',
	...
	'misc_relatedlink_extent_group' => '圈子主题',
	...
	'plugins_edit_modules_type_30' => '手机发现页导航项目',
	...
	'ec_qpay_op_user_id_comment' => '退款时用到的操作员账号, 默认为商户号',
	...
	'project_option_group_allowbuildgroup' => '是否允许建立圈子',
	...
	'project_option_group_allowgroupdirectpost' => '是否允许直接在圈子中发帖',
	'project_option_group_allowgroupposturl' => '是否允许在圈子中发站外URL',
	...
	'counter_groupmember_num' => '重建圈子成员数',
	'counter_groupmember_post' => '重建圈子成员发帖数',
	'counter_groupnum' => '重建分类圈子数',
	...
	'group_level_add' => '增加圈子等级',
	'group_level_tips' => '<li>圈子等级不宜设置过多。</li><li>当允许圈子内发帖等操作影响用户积分时应谨慎，用户有可能通过圈子刷积分。</li><li>默认等级图标大小是25 X 25像素。</li>',
	...
	'group_level_special_allowchangename' => '允许创始人改圈子名',
	'group_level_special_allowchangetype' => '允许创始人更改圈子分类',
	'group_level_special_allowclose' => '允许创始人关闭圈子',
	...
	'connect_setting_allow_comment' => 'QQ绑定功能开启后，用户可以通过QQ账号登录站点，以及更多和QQ相关的操作',
	...
	'connect_member_bindlog_uin' => 'QQ账号绑定日志',
	'connect_member_bindlog_uid' => '用户账号绑定日志',
...
{caddy}
	...
	'download_latest' => 'Discuz! X3.5 最新版本下载',
