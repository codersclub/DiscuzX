...
$lang = array (
  ...
  'group_only_one_moderator' => '抱歉，只剩最后一个圈主，必须由管理员在后台删除{_G/setting/navs/3/navname}',
  ...
  'credits_transfer_succeed' => '积分转账成功 ',
  ...
  'location_login' => '',
  'location_login_force_qq' => '您所在的用户组必须使用QQ账号登录',
  'location_login_force_mail' => '您所在的用户组必须使用邮箱登录',
  'location_login_outofdate' => '您当前的账号已经太长时间未登录网站已经被冻结，必须验证邮箱后才能解除冻结状态',
  'location_login_succeed_mobile' => '欢迎您回来，{username}。点击进入登录前页面',
  'location_login_succeed' => '',
  'location_activation' => '您的账号处于未激活状态，点击进行激活',
  'login_succeed_inactive_member' => '欢迎您回来，{usergroup} {username}。您的账号处于非激活状态，部分功能可能无法正常使用，现在将转入密码安全页面',
  ...
  'register_activation_message' => '抱歉，您输入的用户名 "{username}" 已存在，请登录站点激活此账号',
  ...
  'secmobseccode_send_err_5' => '本站点不支持向您安全手机号所在区域发送短信，请更换号码或稍候再试。',
