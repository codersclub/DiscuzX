...
$lang = array (
  ...
  'copyright_s' => '2001-'.date('Y').' <a href="https://code.dismall.com/" target="_blank">Discuz! Team</a>.',
  ...
  'logout' => '退出',
  'my_nav' => '快捷导航',
  'my_nav_login' => '请 <a href="javascript:;" class="xi2" onclick="lsSubmit()"><strong>登录</strong></a> 后使用快捷导航<br />没有账号？<a href="member.php?mod={$_G[\'setting\'][\'regname\']}" class="xi2 xw1">$_G[\'setting\'][\'reglinkname\']</a>',
  'open_diy' => '打开 DIY 面板',
  'pm_center' => '消息',
